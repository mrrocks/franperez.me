...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Am(n,e,t){const i=new Float32Array(pi),r=new H(0,1,0);return new bn({name:"SphericalGaussianBlur",defines:{n:pi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ys(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function jl(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ys(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Ql(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ys(),fragmentShader:`
...
`)}function U_(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(br).join(`
 ...
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const bt=(n,e)=>et(n)?e:n,Mc=(n,e)=>{var s;const t=n.match(Jg),i=e[ar]?e:document.documentElement;let r=(s=getComputedStyle(i))==null?void 0:s.getPropertyValue(t[1]);return(!r||r.trim()===lr)&&t[2]&&(r=t[2].trim()),r||0},Ln=(n,e,t,i,r,s)=>{if(bi(n)){if(!r){const o=n(e,t,i,s);return isNaN(+o)?o||0:+o}const a=()=>{const o=n(e,t,i,s);return isNaN(+o)?o||0:+o};return r.func=a,a()}if(fr(n)&&Gn(n,zg)){if(!r)return Mc(n,e);const a=()=>Mc(n,e);return r.func=a,a()}return n},Lu=(n,e)=>n[ar]?n[Mu]&&t0(n,e)?gt.ATTRIBUTE:Bs.includes(e)||Eu.get(e)?gt.TRANSFORM:Gn(e,"--")?gt.CSS_VAR:e in n.style?gt.CSS:e in n?gt.OBJECT:gt.ATTRIBUTE:gt.OBJECT,Ec=(n,e,t)=>{const i=n.style[e];i&&t&&(t[e]=i);const r=i||getComputedStyle(n[Bg]||n).getPropertyValue(e);return r==="auto"?"0":r},Er=(n,e,t,i)=>{const r=et(t)?Lu(n,e):t,s=Du(n,e);if(s){const a=s.get(n);return a&&i&&(i[e]=a),a??0}if(r===gt.OBJECT){const a=n[e];return a&&i&&(i[e]=a),a||0}if(r===gt.ATTRIBUTE){const a=n.getAttribute(e);return a&&i&&(i[e]=a),a}return r===gt.TRANSFORM?o0(n,e,i):r===gt.CSS_VAR?Ec(n,e,i).trimStart():Ec(n,e,i)},Rs=(n,e,t)=>t==="-"?n-e:t==="+"?n+e:n*e,el=()=>({t:Ze.NUMBER,n:0,u:null,o:null,d:null,s:null}),en=(n,e)=>{if(e.t=Ze.NUMBER,e.n=0,e.u=null,e.o=null,e.d=null,e.s=null,!n)return e;const t=+n;if(!isNaN(t))return e.n=t,e;let i=n;i[1]==="="&&(e.o=i[0],i=i.slice(2));const r=i.includes(" ")?!1:$g.exec(i);if(r)return e.t=Ze.UNIT,e.n=+r[1],e.u=r[2],e;if(e.o)return e.n=+i,e;if(Qg(i))return e.t=Ze.COLOR,e.d=f0(i),e;{const s=i.match(vc);return e.t=Ze.COMPLEX,e.d=s?s.map(Number):[],e.s=i.split(vc)||[],e}},Tc=(n,e)=>(e.t=n._valueType,e.n=n._toNumber,e.u=n._unit,e.o=null,e.d=Nt(n._toNumbers),e.s=Nt(n._strings),e),ln=el(),Iu=(n,e,t)=>{const i=n._modifier,r=n._fromNumbers,s=n._toNumbers,a=n._strings;let o=a[0];for(let c=0,l=s.length;c<l;c++){const f=i(_t(As(r[c],s[c],e),t)),d=a[c+1];o+=`${d?f+d:f}`,n._numbers[c]=f}return o};/**
 * Anime.js - core - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Cs=(n,e,t,i,r)=>{const s=n.parent,a=n.duration,o=n.completed,c=n.iterationDuration,l=n.iterationCount,f=n._currentIteration,d=n._loopDelay,u=n._reversed,h=n._alternate,g=n._hasChildren,S=n._delay,m=n._currentTime,p=S+c,E=e-S,b=fn(m,-S,a),y=fn(E,-S,a),D=E-m,T=y>0,C=y>=a,x=a<=st,A=r===Zt.FORCE;let U=0,R=E,O=0;if(l>1){const F=c+(C?0:d),J=~~(y/F);n._currentIteration=fn(J,0,l),C&&n._currentIteration--,U=n._currentIteration%2,R=y-J*F||0}const X=u^(h&&U),Z=n._ease;let P=C?X?0:a:X?c-R:R;Z&&(P=c*Z(P/c)||0);const B=(s?s.backwards:E<m)?!X:!!X;if(n._currentTime=E,n._iterationTime=P,n.backwards=B,T&&!n.began?(n.began=!0,!t&&!(s&&(B||!s.began))&&n.onBegin(n)):E<=0&&(n.began=!1),!t&&!g&&T&&n._currentIteration!==f&&n.onLoop(n),A||r===Zt.AUTO&&(e>=(s&&S>0?0:S)&&e<=p||e<=S&&b>S||e>=p&&b!==a)||P>=p&&b!==a||P<=S&&b>0&&!C||e<=b&&b===a&&o||C&&!o&&x){if(T&&(n.computeDeltaTime(b),t||n.onBeforeUpdate(n)),!g){const F=A||(B?D*-1:D)>=yt.tickThreshold,J=_t(n._offset+(s?s._offset:0)+S+P,12);let G=n._head,Q,de,xe,He,je=0;for(;G;){const we=G._composition,q=G._currentTime,ce=G._changeDuration,te=G._absoluteStartTime+G._changeDuration,ue=G._nextRep,Te=G._prevRep,ye=we!==Ft.none,$e=Te?Te._absoluteStartTime+Te._changeDuration:0,Le=Te&&Te.parent!==G.parent,Ye=!ue||ue._isOverridden?te:ue.parent===G.parent?te+ue._delay:ue._absoluteStartTime<ue._absoluteUpdateStartTime?ue._absoluteStartTime:ue._absoluteUpdateStartTime;if((F||(q!==ce||J<=Ye||Te&&!Le&&(!ue||ue.parent!==G.parent))&&(q!==0||J>=G._absoluteStartTime||Le&&!G._hasFromValue&&!Te._isOverridden&&J>=$e||ue&&!ue._isOverridden&&ue.parent===G.parent&&ue._currentTime!==0&&P<ue._startTime))&&(!Te||Le||P>=G._startTime)&&(!ye||!G._isOverridden&&(!G._isOverlapped||J<=te)&&(!ue||ue._isOverridden||J<=Ye)&&(!Te||Te._isOverridden||(Le?J>=G._absoluteStartTime||!G._hasFromValue&&J>=$e:J>=$e+G._delay)))){const tt=G._currentTime=fn(P-G._startTime,0,ce),Re=G._ease(tt/G._updateDuration),nt=G._modifier,Ke=G._valueType,dt=G._tweenType,L=dt===gt.OBJECT,at=Ke===Ze.NUMBER,Ue=at&&L||Re===0||Re===1?-1:yt.precision;let Ne,ae;if(at)Ne=ae=nt(_t(As(G._fromNumber,G._toNumber,Re),Ue));else if(Ke===Ze.UNIT)ae=nt(_t(As(G._fromNumber,G._toNumber,Re),Ue)),Ne=`${ae}${G._unit}`;else if(Ke===Ze.COLOR){const We=G._numbers,M=G._fromNumbers,_=G._toNumbers,N=1-Re,$=M[0],j=M[1],ne=M[2],re=_[0],W=_[1],K=_[2];We[0]=nt(Math.sqrt($*$*N+re*re*Re)),We[1]=nt(Math.sqrt(j*j*N+W*W*Re)),We[2]=nt(Math.sqrt(ne*ne*N+K*K*Re)),We[3]=nt(As(M[3],_[3],Re)),(!G._setter||i)&&(Ne=`rgba(${_t(We[0],0)},${_t(We[1],0)},${_t(We[2],0)},${We[3]})`)}else Ke===Ze.COMPLEX&&(Ne=Iu(G,Re,Ue));if(ye&&(G._number=ae),!i&&we!==Ft.blend){const We=G.property;Q=G.target,G._setter?G._setter(Q,ae,G):L?Q[We]=Ne:dt===gt.ATTRIBUTE?Q.setAttribute(We,Ne):(de=Q.style,dt===gt.TRANSFORM?(Q!==xe&&(xe=Q,He=Q[Zs]),He[We]=Ne,je=1):dt===gt.CSS?de[We]=Ne:dt===gt.CSS_VAR&&de.setProperty(We,Ne)),T&&(O=1)}else G._value=Ne}else q&&Te&&!Le&&P<G._startTime&&(G._currentTime=0);je&&G._renderTransforms&&(de.transform=Pu(He),je=0),G=G._next}!t&&O&&n.onRender(n)}!t&&T&&n.onUpdate(n)}return s&&x?!t&&(s.began&&!B&&E>0&&!o||B&&E<=st&&o)&&(n.onComplete(n),n.completed=!B):T&&C?l===1/0?n._startTime+=n.duration:n._currentIteration>=l-1&&(n.paused=!0,!o&&!g&&(n.completed=!0,!t&&!(s&&(B||!s.began))&&(n.onComplete(n),n._resolve(n)))):n.completed=!1,O},mi=(n,e,t,i,r)=>{const s=n._currentIteration;if(Cs(n,e,t,i,r),n._hasChildren){const a=n,o=a.backwards,c=i?e:a._iterationTime,l=cr();let f=0,d=!0;if(!i&&a._currentIteration!==s){const u=a.iterationDuration;xt(a,h=>{if(!o)!h.completed&&!h.backwards&&h._currentTime<h.iterationDuration&&Cs(h,u,t,1,Zt.FORCE),h.began=!1,h.completed=!1;else{const g=h.duration,S=h._offset+h._delay,m=S+g;!t&&g<=st&&(!S||m===u)&&h.onComplete(h)}}),t||a.onLoop(a)}xt(a,u=>{const h=_t((c-u._offset)*u._speed,12);if(o&&h>u._delay+u.duration)return;const g=u._fps<a._fps?u.requestTick(l):r;f+=Cs(u,h,t,i,g),!u.completed&&d&&(d=!1)},o),!t&&f&&a.onRender(a),(d||o)&&a._currentTime>=a.duration&&(a.paused=!0,a.completed||(a.completed=!0,t||(a.onComplete(a),a._resolve(a))))}};/**
 * Anime.js - core - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const yc={},Uu=(n,e,t)=>{if(t===gt.TRANSFORM){const i=Eu.get(n);return i||n}else if(t===gt.CSS||t===gt.ATTRIBUTE&&bu(e)&&n in e.style){const i=yc[n];if(i)return i;{const r=n&&yu(n);return yc[n]=r,r}}else return n},tl=(n,e=!1)=>{if(n._hasChildren)xt(n,t=>tl(t,e),!0);else{const t=n;t.pause(),xt(t,i=>{const r=i.property,s=i.target,a=i._tweenType,o=i._inlineValue,c=Ji(o)||o===lr;if(i._setter){if(!e&&!c){if(en(o,ln),ln.d){const l=ln.d,f=i._numbers;for(let d=0,u=l.length;d<u;d++)f[d]=l[d]}else i._number=ln.n;i._setter(i.target,i._number,i)}}else if(a===gt.OBJECT)!e&&!c&&(s[r]=o);else if(s[ar])if(a===gt.ATTRIBUTE)e||(c?s.removeAttribute(r):s.setAttribute(r,o));else{const l=s.style;if(a===gt.TRANSFORM){const f=s[Zs];c?delete f[r]:f[r]=o,i._renderTransforms&&(Object.keys(f).length?l.transform=Pu(f):l.removeProperty("transform"))}else c?l.removeProperty(yu(r)):l[r]=o}s[ar]&&t._tail===i&&t.targets.forEach(l=>{l.getAttribute&&l.getAttribute("style")===lr&&l.removeAttribute("style")})})}return n};/**
 * Anime.js - core - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */class Nu{constructor(e=0){this.deltaTime=0,this._currentTime=e,this._lastTickTime=e,this._startTime=e,this._lastTime=e,this._frameDuration=or/Do,this._fps=Do,this._speed=1,this._hasChildren=!1,this._head=null,this._tail=null}get fps(){return this._fps}set fps(e){const t=+e,i=t<st?st:t,r=or/i;i>zs.frameRate&&(zs.frameRate=i),this._fps=i,this._frameDuration=r}get speed(){return this._speed}set speed(e){const t=+e;this._speed=t<st?st:t}requestTick(e){const t=this._frameDuration,i=e-this._lastTickTime,r=t*.25,s=r<4?r:4;return i+s<t?Zt.NONE:(this._lastTickTime=i>=t?e-i%t:e,Zt.AUTO)}computeDeltaTime(e){const t=e-this._lastTime;return this.deltaTime=t,this._lastTime=e,t}}/**
 * Anime.js - animation - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Qi={animation:null,update:tn},d0=n=>{let e=Qi.animation;return e||(e={duration:st,computeDeltaTime:tn,_offset:0,_delay:0,_head:null,_tail:null},Qi.animation=e,Qi.update=()=>{n.forEach(t=>{for(let i in t){const r=t[i],s=r._head;if(s){const a=s._valueType,o=a===Ze.COMPLEX||a===Ze.COLOR?Nt(s._fromNumbers):null;let c=s._fromNumber,l=r._tail;for(;l&&l!==s;){if(o)for(let f=0,d=l._numbers.length;f<d;f++)o[f]+=l._numbers[f];else c+=l._number;l=l._prevAdd}s._toNumber=c,s._toNumbers=o}}}),Cs(e,1,1,0,Zt.FORCE)}),e};/**
 * Anime.js - engine - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Fu=ai?requestAnimationFrame:setImmediate,h0=ai?cancelAnimationFrame:clearImmediate;class p0 extends Nu{constructor(e){super(e),this.useDefaultMainLoop=!0,this.pauseOnDocumentHidden=!0,this.defaults=zs,this.paused=!0,this.reqId=0}update(){const e=this._currentTime=cr();if(this.requestTick(e)){this.computeDeltaTime(e);const t=this._speed,i=this._fps;let r=this._head;for(;r;){const s=r._next;r.paused?(xi(this,r),this._hasChildren=!!this._tail,r._running=!1,r.completed&&!r._cancelled&&r.cancel()):mi(r,(e-r._startTime)*r._speed*t,0,0,r._fps<i?r.requestTick(e):Zt.AUTO),r=s}Qi.update()}}wake(){return this.useDefaultMainLoop&&!this.reqId&&(this.requestTick(cr()),this.reqId=Fu(Ou)),this}pause(){if(this.reqId)return this.paused=!0,m0()}resume(){if(this.paused)return this.paused=!1,xt(this,e=>e.resetTime()),this.wake()}get speed(){return this._speed*(yt.timeScale===1?1:or)}set speed(e){const t=e*yt.timeScale;this._speed!==t&&(this._speed=t,xt(this,i=>i.speed=i._speed))}get timeUnit(){return yt.timeScale===1?"ms":"s"}set timeUnit(e){const i=e==="s",r=i?.001:1;if(yt.timeScale!==r){yt.timeScale=r,yt.tickThreshold=200*r;const s=i?.001:or;this.defaults.duration*=s,this._speed*=s}}get precision(){return yt.precision}set precision(e){yt.precision=e}}const Pt=(()=>{const n=new p0(cr());return ai&&(Tu.engine=n,Ur.addEventListener("visibilitychange",()=>{n.pauseOnDocumentHidden&&(Ur.hidden?n.pause():n.resume())})),n})(),Ou=()=>{Pt._head?(Pt.reqId=Fu(Ou),Pt.update()):Pt.reqId=0},m0=()=>(h0(Pt.reqId),Pt.reqId=0,Pt);/**
 * Anime.js - animation - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Vs={_rep:new WeakMap,_add:new Map},nl=(n,e,t="_rep")=>{const i=Vs[t];let r=i.get(n);return r||(r={},i.set(n,r)),r[e]?r[e]:r[e]={_head:null,_tail:null}},_0=(n,e)=>n._isOverridden||n._absoluteStartTime>e._absoluteStartTime,ws=n=>{n._isOverlapped=1,n._isOverridden=1,n._changeDuration=st,n._currentTime=st},Bu=(n,e)=>{const t=n._composition;if(t===Ft.replace){const i=n._absoluteStartTime;vi(e,n,_0,"_prevRep","_nextRep");const r=n._prevRep;if(r){const s=r.parent,a=r._absoluteEndTime;if(n.parent.id!==s.id&&s.iterationCount>1&&a+(s.duration-s.iterationDuration)>i){ws(r);let l=r._prevRep;for(;l&&l.parent.id===s.id;)ws(l),l=l._prevRep}const o=n._absoluteUpdateStartTime;if(a>o){const l=r._startTime,f=a-(l+r._updateDuration),d=_t(o-f-l,12);r._changeDuration=d,r._currentTime=d,r._isOverlapped=1,d<st&&ws(r)}const c=n.parent.parent;if(!c||c!==s.parent){let l=!0;if(xt(s,f=>{f._isOverlapped||(l=!1)}),l){const f=s.parent;if(f){let d=!0;xt(f,u=>{u!==s&&xt(u,h=>{h._isOverlapped||(d=!1)})}),d&&f.cancel()}else s.cancel()}}}}else if(t===Ft.blend){const i=nl(n.target,n.property,"_add"),r=d0(Vs._add);let s=i._head;s||(s={...n},s._composition=Ft.replace,s._updateDuration=st,s._startTime=0,s._numbers=Nt(n._fromNumbers),s._number=0,s._next=null,s._prev=null,vi(i,s),vi(r,s));const a=n._toNumber;if(n._fromNumber=s._fromNumber-a,n._toNumber=0,n._numbers=Nt(n._fromNumbers),n._number=0,s._fromNumber=a,n._toNumbers.length){const o=Nt(n._toNumbers);o.forEach((c,l)=>{n._fromNumbers[l]=s._fromNumbers[l]-c,n._toNumbers[l]=0}),s._fromNumbers=o}vi(i,n,null,"_prevAdd","_nextAdd")}return n},zu=n=>{const e=n._composition;if(e!==Ft.none){const t=n.target,i=n.property,a=Vs._rep.get(t)[i];if(xi(a,n,"_prevRep","_nextRep"),e===Ft.blend){const o=Vs._add,c=o.get(t);if(!c)return;const l=c[i],f=Qi.animation;xi(l,n,"_prevAdd","_nextAdd");const d=l._head;if(d&&d===l._tail){xi(l,d,"_prevAdd","_nextAdd"),xi(f,d);let u=!0;for(let h in c)if(c[h]._head){u=!1;break}u&&o.delete(t)}}}return n},bc=(n,e,t)=>{let i=!1;return xt(e,r=>{const s=r.target;if(n.includes(s)){const a=r.property,o=r._tweenType,c=Uu(t,s,o);(!c||c&&c===a)&&(r.parent._tail===r&&r._tweenType===gt.TRANSFORM&&r._prev&&r._prev._tweenType===gt.TRANSFORM&&(r._prev._renderTransforms=1),xi(e,r),zu(r),i=!0)}},!0),i},Vu=(n,e,t)=>{const i=e||Pt;let r;if(i._hasChildren){let s=0;xt(i,a=>{if(!a._hasChildren)if(r=bc(n,a,t),r&&!a._head)a.cancel(),xi(i,a);else{const c=a._offset+a._delay+a.duration;c>s&&(s=c)}a._head?Vu(n,a,t):a._hasChildren=!1},!0),et(i.iterationDuration)||(i.iterationDuration=s)}else r=bc(n,i,t);r&&!i._head&&(i._hasChildren=!1,i.cancel&&i.cancel())};/**
 * Anime.js - timer - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Ac=n=>(n.paused=!0,n.began=!1,n.completed=!1,n),Lo=n=>(n._cancelled&&(n._hasChildren?xt(n,Lo):xt(n,e=>{e._composition!==Ft.none&&Bu(e,nl(e.target,e.property))}),n._cancelled=0),n);let Rc=0;const g0=(n,e)=>n._priority>e._priority;class il extends Nu{constructor(e={},t=null,i=0){super(0),++Rc;const{id:r,delay:s,duration:a,reversed:o,alternate:c,loop:l,loopDelay:f,autoplay:d,frameRate:u,playbackRate:h,priority:g,onComplete:S,onLoop:m,onPause:p,onBegin:E,onBeforeUpdate:b,onUpdate:y}=e,D=t?0:Pt._lastTickTime,T=t?t.defaults:yt.defaults,C=bi(s)||et(s)?T.delay:+s,x=bi(a)||et(a)?1/0:+a,A=bt(l,T.loop),U=bt(f,T.loopDelay);let R=A===!0||A===1/0||A<0?1/0:A+1,O=0;t?O=i:(Pt.reqId||Pt.requestTick(cr()),O=(Pt._lastTickTime-Pt._startTime)*yt.timeScale),this.id=et(r)?Rc:r,this.parent=t,this.duration=Js((x+U)*R-U)||st,this.backwards=!1,this.paused=!0,this.began=!1,this.completed=!1,this.onBegin=E||T.onBegin,this.onBeforeUpdate=b||T.onBeforeUpdate,this.onUpdate=y||T.onUpdate,this.onLoop=m||T.onLoop,this.onPause=p||T.onPause,this.onComplete=S||T.onComplete,this.iterationDuration=x,this.iterationCount=R,this._autoplay=t?!1:bt(d,T.autoplay),this._offset=O,this._delay=C,this._loopDelay=U,this._iterationTime=0,this._currentIteration=0,this._resolve=tn,this._running=!1,this._reversed=+bt(o,T.reversed),this._reverse=this._reversed,this._cancelled=0,this._alternate=bt(c,T.alternate),this._prev=null,this._next=null,this._lastTickTime=D,this._startTime=D,this._lastTime=D,this._fps=bt(u,T.frameRate),this._speed=bt(h,T.playbackRate),this._priority=+bt(g,1)}get cancelled(){return!!this._cancelled}set cancelled(e){e?this.cancel():this.reset(!0).play()}get currentTime(){return fn(_t(this._currentTime,yt.precision),-this._delay,this.duration)}set currentTime(e){const t=this.paused;this.pause().seek(+e),t||this.resume()}get iterationCurrentTime(){return fn(_t(this._iterationTime,yt.precision),0,this.iterationDuration)}set iterationCurrentTime(e){this.currentTime=this.iterationDuration*this._currentIteration+e}get progress(){return fn(_t(this._currentTime/this.duration,10),0,1)}set progress(e){this.currentTime=this.duration*e}get iterationProgress(){return fn(_t(this._iterationTime/this.iterationDuration,10),0,1)}set iterationProgress(e){const t=this.iterationDuration;this.currentTime=t*this._currentIteration+t*e}get currentIteration(){return this._currentIteration}set currentIteration(e){this.currentTime=this.iterationDuration*fn(+e,0,this.iterationCount-1)}get reversed(){return!!this._reversed}set reversed(e){e?this.reverse():this.play()}get speed(){return super.speed}set speed(e){super.speed=e,this.resetTime()}reset(e=!1){return Lo(this),this._reversed&&!this._reverse&&(this.reversed=!1),this._iterationTime=this.iterationDuration,mi(this,0,1,~~e,Zt.FORCE),Ac(this),this._hasChildren&&xt(this,Ac),this}init(e=!1){this.fps=this._fps,this.speed=this._speed,!e&&this._hasChildren&&mi(this,this.duration,1,~~e,Zt.FORCE),this.reset(e);const t=this._autoplay;return t===!0?this.resume():t&&!et(t.linked)&&t.link(this),this}resetTime(){const e=1/(this._speed*Pt._speed);return this._startTime=cr()-(this._currentTime+this._delay)*e,this}pause(){return this.paused?this:(this.paused=!0,this.onPause(this),this)}resume(){return this.paused?(this.paused=!1,this.duration<=st&&!this._hasChildren?mi(this,st,0,0,Zt.FORCE):(this._running||(vi(Pt,this,g0),Pt._hasChildren=!0,this._running=!0),this.resetTime(),this._startTime-=12,Pt.wake()),this):this}restart(){return this.reset().resume()}seek(e,t=0,i=0){Lo(this),this.completed=!1;const r=this.paused;return this.paused=!0,mi(this,e+this._delay,~~t,~~i,Zt.AUTO),r?this:this.resume()}alternate(){const e=this._reversed,t=this.iterationCount,i=this.iterationDuration,r=t===1/0?s0(Po/i):t;return this._reversed=+(this._alternate&&!(r%2)?e:!e),t===1/0?this.iterationProgress=this._reversed?1-this.iterationProgress:this.iterationProgress:this.seek(i*r-this._currentTime),this.resetTime(),this}play(){return this._reversed&&this.alternate(),this.resume()}reverse(){return this._reversed||this.alternate(),this.resume()}cancel(){return this._hasChildren?xt(this,e=>e.cancel(),!0):xt(this,zu),this._cancelled=1,this.pause()}stretch(e){const t=this.duration,i=ji(e);if(t===i)return this;const r=e/t,s=e<=st;return this.duration=s?st:i,this.iterationDuration=s?st:ji(this.iterationDuration*r),this._offset*=r,this._delay*=r,this._loopDelay*=r,this}revert(){mi(this,0,1,0,Zt.AUTO);const e=this._autoplay;return e&&e.linked&&e.linked===this&&e.revert(),this.cancel()}complete(e=0){return this.seek(this.duration,e).cancel()}then(e=tn){const t=this.then,i=()=>{this.then=null,e(this),this.then=t,this._resolve=tn};return new Promise(r=>(this._resolve=()=>r(i()),this.completed&&this._resolve(),this))}}/**
 * Anime.js - core - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */function Cc(n){const e=fr(n)?jg.root.querySelectorAll(n):n;if(e instanceof NodeList||e instanceof HTMLCollection)return e}function Io(n){if(Ji(n))return[];if(!ai)return ur(n)&&n.flat(1/0)||[n];if(ur(n)){const t=n.flat(1/0),i=[];for(let r=0,s=t.length;r<s;r++){const a=t[r];if(!Ji(a)){const o=Cc(a);if(o)for(let c=0,l=o.length;c<l;c++){const f=o[c];if(!Ji(f)){let d=!1;for(let u=0,h=i.length;u<h;u++)if(i[u]===f){d=!0;break}d||i.push(f)}}else{let c=!1;for(let l=0,f=i.length;l<f;l++)if(i[l]===a){c=!0;break}c||i.push(a)}}}return i}const e=Cc(n);return e?Array.from(e):[n]}function x0(n){const e=Io(n),t=e.length;for(let i=0;i<t;i++){const r=e[i];if(!r[xc]){r[xc]=!0;const s=bu(r);(r.nodeType||s)&&(r[ar]=!0,r[Mu]=s,r[Zs]={})}}return e}/**
 * Anime.js - core - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 ...
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Tr=(n=1.68)=>e=>$i(e,+n),Uo={in:n=>e=>n(e),out:n=>e=>1-n(1-e),inOut:n=>e=>e<.5?n(e*2)/2:1-n(e*-2+2)/2,outIn:n=>e=>e<.5?(1-n(1-e*2))/2:(n(e*2-1)+1)/2},v0=Qo/2,Dc=Qo*2,Lc={[lr]:Tr,Quad:Tr(2),Cubic:Tr(3),Quart:Tr(4),Quint:Tr(5),Sine:n=>1-r0(n*v0),Circ:n=>1-n0(1-n*n),Expo:n=>n?$i(2,10*n-10):0,Bounce:n=>{let e,t=4;for(;n<((e=$i(2,--t))-1)/11;);return 1/$i(4,3-t)-7.5625*$i((e*3-2)/22-n,2)},Back:(n=1.7)=>e=>(+n+1)*e*e*e-+n*e*e,Elastic:(n=1,e=.3)=>{const t=fn(+n,1,10),i=fn(+e,st,2),r=i/Dc*a0(1/t),s=Dc/i;return a=>a===0||a===1?a:-t*$i(2,-10*(1-a))*i0((1-a-r)*s)}},Na=(()=>{const n={linear:si,none:si};for(let e in Uo)for(let t in Lc){const i=Lc[t],r=Uo[e];n[e+t]=t===lr||t==="Back"||t==="Elastic"?(s,a)=>r(i(s,a)):r(i)}return n})(),us={linear:si,none:si},S0=n=>{if(us[n])return us[n];if(n.indexOf("(")<=-1){const t=Uo[n]||n.includes("Back")||n.includes("Elastic")?Na[n]():Na[n];return t?us[n]=t:si}else{const e=n.slice(0,-1).split("("),t=Na[e[0]];return t?us[n]=t(...e[1].split(",")):si}},Ic=["steps(","irregular(","linear(","cubicBezier("],No=n=>{if(fr(n)){for(let t=0,i=Ic.length;t<i;t++)if(Gn(n,Ic[t]))return console.warn(`String syntax for \`ease: "${n}"\` has been removed from the core and replaced by importing and passing the easing function directly: \`ease: ${n}\``),si}return bi(n)?n:fr(n)?S0(n):si};/**
 * Anime.js - animation - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Ie=el(),ke=el(),ki={},fs={func:null},ds={func:null},hs=[null],Wi=[null,null],ps={to:null};let M0=0,Uc=0,ti,gn;const E0=(n,e)=>{const t={};if(ur(n)){const i=[].concat(...n.map(r=>Object.keys(r))).filter(bs);for(let r=0,s=i.length;r<s;r++){const a=i[r],o=n.map(c=>{const l={};for(let f in c){const d=c[f];bs(f)?f===a&&(l.to=d):l[f]=d}return l});t[a]=o}}else{const i=bt(e.duration,yt.defaults.duration);Object.keys(n).map(s=>({o:parseFloat(s)/100,p:n[s]})).sort((s,a)=>s.o-a.o).forEach(s=>{const a=s.o,o=s.p;for(let c in o)if(bs(c)){let l=t[c];l||(l=t[c]=[]);const f=a*i;let d=l.length,u=l[d-1];const h={to:o[c]};let g=0;for(let S=0;S<d;S++)g+=l[S].duration;d===1&&(h.from=u.to),o.ease&&(h.ease=o.ease),h.duration=f-(d?g:0),l.push(h)}return s});for(let s in t){const a=t[s];let o;for(let c=0,l=a.length;c<l;c++){const f=a[c],d=f.ease;f.ease=o||void 0,o=d}a[0].duration||a.shift()}}return t};class Gu extends il{constructor(e,t,i,r,s=!1,a=0,o){super(t,i,r),this._head,this._tail,++Uc;const c=x0(e),l=c.length,f=t.keyframes,d=f?wu(E0(f,t),t):t,{id:u,delay:h,duration:g,ease:S,playbackEase:m,modifier:p,composition:E,onRender:b}=d,y=i?i.defaults:yt.defaults,D=bt(S,y.ease),T=bt(m,y.playbackEase),C=T?No(T):null,x=!et(D.ease),A=x?D.ease:bt(S,C?"linear":y.ease),U=x?D.settlingDuration:bt(g,y.duration),R=bt(h,y.delay),O=p||y.modifier,X=et(E)&&l>=or?Ft.none:et(E)?y.composition:E,Z=this._offset+(i?i._offset:0);x&&(D.parent=this);let P=NaN,B=NaN,F=0,J=0;for(let G=0;G<l;G++){const Q=c[G],de=a||G,xe=o||c;let He=NaN,je=NaN;for(let we in d)if(bs(we)){const q=Lu(Q,we),ce=Du(Q,we),te=Uu(we,Q,q);let ue=d[we];const Te=ur(ue);if(s&&!Te&&(Wi[0]=ue,Wi[1]=ue,ue=Wi),Te){const Re=ue.length,nt=!wr(ue[0]);Re===2&&nt?(ps.to=ue,hs[0]=ps,ti=hs):Re>2&&nt?(ti=[],ue.forEach((Ke,dt)=>{dt?dt===1?(Wi[1]=Ke,ti.push(Wi)):ti.push(Ke):Wi[0]=Ke})):ti=ue}else hs[0]=ue,ti=hs;let ye=null,$e=null,Le=NaN,Ye=0,tt=0;for(let Re=ti.length;tt<Re;tt++){const nt=ti[tt];wr(nt)?gn=nt:(ps.to=nt,gn=ps),fs.func=null,ds.func=null;const Ke=Ln(bt(gn.composition,X),Q,de,xe,null,null),dt=jo(Ke)?Ke:Ft[Ke];!ye&&dt!==Ft.none&&(ye=nl(Q,te));const L=ye?ye._tail:null,at=i&&L&&L.parent.parent===i?L:$e,Ue=Ln(gn.to,Q,de,xe,fs,at);let Ne;wr(Ue)&&!et(Ue.to)?(gn=Ue,Ne=Ue.to):Ne=Ue;const ae=Ln(gn.from,Q,de,xe,ds,at),We=gn.ease||A,M=Ln(We,Q,de,xe,null,at),_=bi(M)||fr(M)?M:We,N=!et(_)&&!et(_.ease),$=N?_.ease:_,j=N?_.settlingDuration:Ln(bt(gn.duration,Re>1?Ln(U,Q,de,xe,null,at)/Re:U),Q,de,xe,null,at),ne=Ln(bt(gn.delay,tt?0:R),Q,de,xe,null,at),re=gn.modifier||O,W=!et(ae),K=!et(Ne),fe=ur(Ne),ve=fe||W&&K,le=$e?Ye:0,ie=$e?Ye+ne:ne,Pe=_t(Z+ie,12),ze=_t(Z+le,12);!J&&(W||fe)&&(J=1);let Oe=$e;if(dt!==Ft.none){let Ce=ye._head;for(;Ce&&Ce._absoluteStartTime<=Pe;)if(Ce._isOverridden||(Oe=Ce),Ce=Ce._nextRep,Ce&&Ce._absoluteStartTime>=Pe)for(;Ce;)ws(Ce),Ce=Ce._nextRep}if(ve){en(fe?Ln(Ne[0],Q,de,xe,ds,at):ae,Ie),en(fe?Ln(Ne[1],Q,de,xe,fs,at):Ne,ke);const Ce=Er(Q,te,q,ki);Ie.t===Ze.NUMBER&&(Oe?Oe._valueType===Ze.UNIT&&(Ie.t=Ze.UNIT,Ie.u=Oe._unit):(en(Ce,ln),ln.t===Ze.UNIT&&(Ie.t=Ze.UNIT,Ie.u=ln.u)))}else K?en(Ne,ke):$e?Tc($e,ke):en(i&&Oe&&Oe.parent.parent===i?Oe._value:Er(Q,te,q,ki),ke),W?en(ae,Ie):$e?Tc($e,Ie):en(i&&Oe&&Oe.parent.parent===i?Oe._value:Er(Q,te,q,ki),Ie);if(Ie.o&&(Ie.n=Rs(Oe?Oe._toNumber:en(Er(Q,te,q,ki),ln).n,Ie.n,Ie.o)),ke.o&&(ke.n=Rs(Ie.n,ke.n,ke.o)),Ie.t!==ke.t){if(Ie.t===Ze.COMPLEX||ke.t===Ze.COMPLEX){const Ce=Ie.t===Ze.COMPLEX?Ie:ke,Be=Ie.t===Ze.COMPLEX?ke:Ie;Be.t=Ze.COMPLEX,Be.s=Nt(Ce.s),Be.d=Ce.d.map(()=>Be.n)}else if(Ie.t===Ze.UNIT||ke.t===Ze.UNIT){const Ce=Ie.t===Ze.UNIT?Ie:ke,Be=Ie.t===Ze.UNIT?ke:Ie;Be.t=Ze.UNIT,Be.u=Ce.u}else if(Ie.t===Ze.COLOR||ke.t===Ze.COLOR){const Ce=Ie.t===Ze.COLOR?Ie:ke,Be=Ie.t===Ze.COLOR?ke:Ie;Be.t=Ze.COLOR,Be.d=Ce.d.map(()=>0)}}if(Ie.u!==ke.u){let Ce=ke.u?Ie:ke;Ce=Pc(Q,Ce,ke.u?ke.u:Ie.u,!1)}if(ke.d&&Ie.d&&ke.d.length!==Ie.d.length){const Ce=Ie.d.length>ke.d.length?Ie:ke,Be=Ce===Ie?ke:Ie;Be.d=Ce.d.map((hn,Wt)=>et(Be.d[Wt])?0:Be.d[Wt]),Be.s=Nt(Ce.s)}const w=_t(+j||st,12);let se=ki[te];Ji(se)||(ki[te]=null);const Y=ce?ce.set:null;Ye=_t(ie+w,12);const pe=Ie.d,oe=ke.d,ee=ke.s,ge={parent:this,id:M0++,property:te,target:Q,_value:null,_toFunc:fs.func,_fromFunc:ds.func,_ease:No($),_fromNumbers:pe?Nt(pe):cs,_toNumbers:oe?Nt(oe):cs,_strings:ee?Nt(ee):cs,_fromNumber:Ie.n,_toNumber:ke.n,_numbers:pe?Nt(pe):cs,_number:Ie.n,_unit:ke.u,_modifier:re,_currentTime:0,_startTime:ie,_delay:+ne,_updateDuration:w,_changeDuration:w,_absoluteStartTime:Pe,_absoluteUpdateStartTime:ze,_absoluteEndTime:_t(Z+Ye,12),_hasFromValue:W||fe?1:0,_tweenType:q,_setter:Y,_valueType:ke.t,_composition:dt,_isOverlapped:0,_isOverridden:0,_renderTransforms:0,_inlineValue:se,_prevRep:null,_nextRep:null,_prevAdd:null,_nextAdd:null,_prev:null,_next:null};dt!==Ft.none&&Bu(ge,ye);const Fe=ge._valueType;if(Fe===Ze.COMPLEX)ge._value=Iu(ge,1,-1);else if(Fe===Ze.UNIT)ge._value=`${re(ge._toNumber)}${ge._unit}`;else if(Fe===Ze.COLOR){const Ce=ke.d;ge._value=`rgba(${_t(Ce[0],0)},${_t(Ce[1],0)},${_t(Ce[2],0)},${Ce[3]})`}else ge._value=re(ge._toNumber);isNaN(Le)&&(Le=ge._startTime),$e=ge,F++,vi(this,ge)}(isNaN(B)||Le<B)&&(B=Le),(isNaN(P)||Ye>P)&&(P=Ye),q===gt.TRANSFORM&&(He=F-tt,je=F)}if(!isNaN(He)){let we=0;xt(this,q=>{we>=He&&we<je&&(q._renderTransforms=1,q._composition===Ft.blend&&xt(Qi.animation,ce=>{ce.id===q.id&&(ce._renderTransforms=1)})),we++})}}l||console.warn("No target found. Make sure the element you're trying to animate is accessible before creating your animation."),B?(xt(this,G=>{G._startTime-G._delay||(G._delay-=B),G._startTime-=B}),P-=B):B=0,P||(P=st,this.iterationCount=0),this.targets=c,this.id=et(u)?Uc:u,this.duration=P===st?st:Js((P+this._loopDelay)*this.iterationCount-this._loopDelay)||st,this.onRender=b||y.onRender,this._ease=C,this._delay=B,this.iterationDuration=P,!this._autoplay&&J&&this.onRender(this)}stretch(e){const t=this.duration;if(t===ji(e))return this;const i=e/t;return xt(this,r=>{r._updateDuration=ji(r._updateDuration*i),r._changeDuration=ji(r._changeDuration*i),r._currentTime*=i,r._delay*=i,r._startTime*=i,r._absoluteStartTime*=i,r._absoluteUpdateStartTime*=i,r._absoluteEndTime*=i}),super.stretch(e)}refresh(){return xt(this,e=>{const t=e._toFunc,i=e._fromFunc;(t||i)&&(i?(en(i(),Ie),Ie.u!==e._unit&&e.target[ar]&&Pc(e.target,Ie,e._unit,!0),e._fromNumbers=Nt(Ie.d),e._fromNumber=Ie.n):t&&(en(Er(e.target,e.property,e._tweenType),ln),e._fromNumbers=Nt(ln.d),e._fromNumber=ln.n),t&&(en(t(),ke),e._toNumbers=Nt(ke.d),e._strings=Nt(ke.s),e._toNumber=ke.o?Rs(e._fromNumber,ke.n,ke.o):ke.n))}),this.duration===st&&this.restart(),this}revert(){return super.revert(),tl(this)}then(e){return super.then(e)}}const Gs=(n,e)=>new Gu(n,e,null,0,!1).init();/**
 * Anime.js - timeline - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const T0=(n,e)=>{if(Gn(e,"<")){const t=e[1]==="<",i=n._tail,r=i?i._offset+i._delay:0;return t?r:r+i.duration}},ms=(n,e)=>{let t=n.iterationDuration;if(t===st&&(t=0),et(e))return t;if(jo(+e))return+e;const i=e,r=n?n.labels:null,s=!Ji(r),a=T0(n,i),o=!et(a),c=Zg.exec(i);if(c){const l=c[0],f=i.split(l),d=s&&f[0]?r[f[0]]:t,u=o?a:s?d:t,h=+f[1];return Rs(u,h,l[0])}else return o?a:s?et(r[i])?t:r[i]:t};/**
 * Anime.js - timeline - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */function y0(n){return Js((n.iterationDuration+n._loopDelay)*n.iterationCount-n._loopDelay)||st}function Fa(n,e,t,i,r,s){const o=jo(n.duration)&&n.duration<=st?t-st:t;e.composition&&mi(e,o,1,1,Zt.AUTO);const c=i?new Gu(i,n,e,o,!1,r,s):new il(n,e,o);return e.composition&&c.init(!0),vi(e,c),xt(e,l=>{const d=l._offset+l._delay+l.duration;d>e.iterationDuration&&(e.iterationDuration=d)}),e.duration=y0(e),e}let Nc=0;class b0 extends il{constructor(e={}){super(e,null,0),++Nc,this.id=et(e.id)?Nc:e.id,this.duration=0,this.labels={};const t=e.defaults,i=yt.defaults;this.defaults=t?wu(t,i):i,this.composition=bt(e.composition,!0),this.onRender=e.onRender||i.onRender;const r=bt(e.playbackEase,i.playbackEase);this._ease=r?No(r):null,this.iterationDuration=0}add(e,t,i){const r=wr(t),s=wr(e);if(r||s){if(this._hasChildren=!0,r){const a=t,o=i&&i.type==="Stagger"&&yt.editor,c=bi(i)?i:null;if(c||o){const l=Io(e),f=this.duration,d=this.iterationDuration,u=a.id;let h=0;l.length;const g=c||yt.editor.resolveStagger(i.defaultValue);l.forEach(S=>{const m={...a};this.duration=f,this.iterationDuration=d,et(u)||(m.id=u+"-"+h);const p=ms(this,g(S,h,l,null,this));Fa(m,this,p,S,h,l),h++})}else{const l=a,f=i&&i.type?i.defaultValue:i;Fa(l,this,ms(this,f),e)}}else Fa(e,this,ms(this,t));return this.composition&&this.init(!0),this}}sync(e,t){if(et(e)||e&&et(e.pause))return this;e.pause();const i=+(e.effect?e.effect.getTiming().duration:e.duration);return!et(e)&&!et(e.persist)&&(e.persist=!0),this.add(e,{currentTime:[0,i],duration:i,delay:0,ease:"linear",playbackEase:"linear"},t)}set(e,t,i){return et(t)?this:(t.duration=st,t.composition=Ft.replace,this.add(e,t,i))}call(e,t){return et(e)||e&&!bi(e)?this:this.add({duration:0,delay:0,onComplete:()=>e(this)},t)}label(e,t){return et(e)||e&&!fr(e)?this:(this.labels[e]=ms(this,t),this)}remove(e,t){return Vu(Io(e),this,t),this}stretch(e){const t=this.duration;if(t===ji(e))return this;const i=e/t,r=this.labels;xt(this,s=>s.stretch(s.duration*i));for(let s in r)r[s]*=i;return super.stretch(e)}refresh(){return xt(this,e=>{e.refresh&&e.refresh()}),this}revert(){return super.revert(),xt(this,e=>e.revert,!0),tl(this)}then(e){return super.then(e)}}const A0=n=>new b0(n).init(),Hu=document.querySelector(".illustration"),R0=new DOMParser,Si=["#94f4c3","#a2f8cc","#acfed4","#b0fbd5","#b9feda","#c2fee0","#c5fee1","#d4fee9"],C0=new Set(Si),$t={dial:0,disc:0,gear:0,smallDial:0,splitDisc:0},Hs=new Set;let Vt,er,tr,Fo,Pr,rl=!1;function w0(n,e){const t=new Map;n.querySelectorAll("[id]").forEach(i=>{const r=i.id,s=`${e}-${r}`;t.set(r,s),i.id=s}),n.querySelectorAll("*").forEach(i=>{for(const r of i.attributes){let s=r.value;t.forEach((a,o)=>{s=s.replaceAll(`url(#${o})`,`url(#${a})`),s===`#${o}`&&(s=`#${a}`)}),r.value=s}})}async function Fc(n,e,t){const i=await fetch(e);if(!i.ok)throw new Error(`Unable to load ${e}`);const s=R0.parseFromString(await i.text(),"image/svg+xml").documentElement;return w0(s,t),s.classList.add("illustration__svg"),Hu.querySelector(n).replaceChildren(s),s}function _s(n,{x:e,y:t,width:i,height:r}){const s=n.getBBox(),a=s.x+s.width/2,o=s.y+s.height/2;return a>=e&&a<=e+i&&o>=t&&o<=t+r}function Xi(n,e){return n.forEach(t=>t.classList.add("illustration__part",`illustration__part--${e}`)),n}function P0(n){const e=n.match(/[a-zA-Z]|[-+]?(?:\d*\.)?\d+(?:e[-+]?\d+)?/g)??[],t=[];let i,r,s=0,a=0,o=0,c=0,l=0;const f=g=>/^[a-zA-Z]$/.test(g),d=()=>l<e.length&&!f(e[l]),u=()=>Number(e[l++]),h=(g,S)=>{s=g,a=S,r.push({x:g,y:S})};for(;l<e.length;){if(f(e[l])&&(i=e[l++]),!i)throw new Error(`Invalid path data: ${n}`);const g=i===i.toLowerCase();switch(i.toUpperCase()){case"M":{let S=!0;for(;d();){const m=u()+(g?s:0),p=u()+(g?a:0);S&&(r=[],t.push(r),o=m,c=p,S=!1),h(m,p)}i=g?"l":"L";break}case"L":for(;d();){const S=u()+(g?s:0),m=u()+(g?a:0);h(S,m)}break;case"H":for(;d();){const S=u()+(g?s:0);h(S,a)}break;case"V":for(;d();){const S=u()+(g?a:0);h(s,S)}break;case"Z":s=o,a=c,i=void 0;break;default:throw new Error(`Unsupported path command: ${i}`)}}return t}function D0(n){const e=Math.min(1,Math.max(0,n))*(Si.length-1),t=Math.floor(e),i=Math.min(Si.length-1,t+1),r=e-t,s=l=>[Number.parseInt(l.slice(1,3),16),Number.parseInt(l.slice(3,5),16),Number.parseInt(l.slice(5,7),16)],a=s(Si[t]),o=s(Si[i]);return`rgb(${a.map((l,f)=>Math.round(l+(o[f]-l)*r)).join(" ")})`}function L0(n){const e=new Map,t=n.map(o=>{const c=o.getBBox(),l=o.getAttribute("fill");return{centerX:c.x+c.width/2,centerY:c.y+c.height/2,originalFill:l,originalShade:Si.indexOf(l.toLowerCase())/(Si.length-1),path:o,subpaths:P0(o.getAttribute("d")).map(f=>f.map(({x:d,y:u})=>{const h=`${d.toFixed(3)},${u.toFixed(3)}`;return e.has(h)||e.set(h,{baseX:d,baseY:u,x:d,y:u}),e.get(h)}))}}),i=[...e.values()].filter(({baseX:o,baseY:c})=>o!==0&&o!==240&&c!==320&&c!==440),r={progress:0},s=o=>Number(o.toFixed(3));i.forEach((o,c)=>{const l=Math.min(o.baseX,240-o.baseX,o.baseY-320,440-o.baseY);o.amplitudeX=Math.min(12,Math.max(5,l*.3)),o.amplitudeY=Math.min(9,Math.max(4,l*.22)),o.phase=c*2.399%(Math.PI*2)});const a=(o=!0)=>{i.forEach(f=>{const d=Math.sin(r.progress),u=Math.sin(r.progress*2)*.35;f.x=f.baseX+f.amplitudeX*(d*Math.cos(f.phase)+u*Math.sin(f.phase)),f.y=f.baseY+f.amplitudeY*(d*Math.sin(f.phase)-u*Math.cos(f.phase))});const c=Math.cos(r.progress),l=Math.sin(r.progress);t.forEach(({centerX:f,centerY:d,originalFill:u,originalShade:h,path:g,subpaths:S})=>{const m=S.map(y=>{const[D,...T]=y,C=T.map(({x,y:A})=>`L${s(x)} ${s(A)}`).join("");return`M${s(D.x)} ${s(D.y)}${C}Z`}).join("");if(g.setAttribute("d",m),!o){g.setAttribute("fill",u);return}const p=(f-120)/120,E=(d-380)/60,b=Math.min(1,Math.max(0,(p*c+E*l+1.4)/2.8));g.setAttribute("fill",D0(h+(b-.5)*.5))})};return{render:a,reset(){r.progress=0,a(!1)},state:r}}function I0(n,e){const t=[...n.querySelectorAll(":scope > path")],i=Xi(t.filter(p=>_s(p,{x:404,y:64,width:60,height:60})),"disc"),r=Xi(t.filter(p=>_s(p,{x:144,y:224,width:20,height:20})),"split-disc"),s=Xi([[...n.querySelectorAll(":scope > g[mask]")][1]],"gear")[0],a=[...e.querySelectorAll(":scope > g[mask]")][0],o=[...a.querySelectorAll(":scope > path")][0],c=e.querySelector(":scope > mask"),l=Xi([c.querySelector(":scope > path")],"dial-mask")[0],f=Xi([e.querySelector(':scope > path[fill="#6439ED"]:last-of-type')],"dial-cap")[0],d=e.querySelector(':scope > rect[x="44"]'),u=d.cloneNode(),h=[...e.querySelectorAll(':scope > path[fill="#F7C595"]')].find(p=>_s(p,{x:44,y:414,width:52,height:26})),g=document.createElementNS("http://www.w3.org/2000/svg","mask"),S=document.createElementNS("http://www.w3.org/2000/svg","path");g.id="illustration-small-dial-mask",g.setAttribute("maskUnits","userSpaceOnUse"),g.setAttribute("x","44"),g.setAttribute("y","426"),g.setAttribute("width","28"),g.setAttribute("height","28"),S.setAttribute("d","M44 440h28v14H44z"),S.setAttribute("fill","#fff"),g.append(S),e.prepend(g),d.after(u),u.setAttribute("mask",`url(#${g.id})`),Xi([S],"small-dial-mask"),a.before(o),c.setAttribute("x","234"),c.setAttribute("y","434"),c.setAttribute("width","252"),c.setAttribute("height","252");const m=[...e.querySelectorAll(":scope > path[fill]")].filter(p=>{const E=p.getBBox();return C0.has(p.getAttribute("fill").toLowerCase())&&_s(p,{x:0,y:320,width:240,height:120})&&E.width*E.height<2e4});return{dialCap:f,dialCircle:a.querySelector(":scope > circle"),dialEllipse:a.querySelector(":scope > ellipse"),dialMaskPath:l,disc:i,fractal:m,gear:s,knob:n.querySelector(':scope > rect[x="345"]'),smallDialMaskPath:S,smallDialReveal:u,smallDialSegment:h,splitDisc:r}}function Ar(n){return getComputedStyle(document.documentElement).getPropertyValue(n).trim()}function U0(n,e,t,i=0){const r=n.getAttribute(e),s=Gs(n,{[e]:[r,t,r],opacity:[1,.82,1],delay:i,duration:1600,ease:"inOut(3)",onComplete:()=>Hs.delete(s)});Hs.add(s)}function N0(){U0(Vt.knob,"fill",Ar("--color-secondary"),180)}function F0(){if(er){er.restart();return}er=Gs(tr.state,{progress:Math.PI*2,duration:1e4,ease:"linear",loop:!0,onUpdate:()=>tr.render()})}function ku(n=4200){window.clearTimeout(Fo),!(rl||!Vt)&&(Fo=window.setTimeout(O0,n))}function O0(){if(rl||!Vt)return;$t.gear-=90,$t.disc+=180,$t.splitDisc-=180,$t.dial+=90,$t.smallDial-=90;const n=Ar("--color-accent"),e=Ar("--color-highlight"),t=Ar("--color-primary"),i=Ar("--color-secondary"),r="#f7c595",s=[e,t,i,r],a=[n,i,r,t],o=[t,r,e,i],c=$t.dial/90%s.length,l=(Math.abs($t.smallDial)/90%s.length+s.length)%s.length,f=[r,i,n,r],d=[n,r,e,i];N0(),Pr=A0({defaults:{ease:"inOut(3)"},onComplete:()=>ku()}),Pr.add(Vt.gear,{rotate:$t.gear,duration:900},0).add(Vt.disc,{rotate:$t.disc,duration:1e3},120).add(Vt.splitDisc,{rotate:$t.splitDisc,duration:720},260).add(Vt.dialMaskPath,{rotate:$t.dial,duration:1200},360).add(Vt.dialCap,{fill:o[c],rotate:$t.dial,duration:1200},360).add(Vt.dialEllipse,{fill:s[c],duration:1200},360).add(Vt.dialCircle,{fill:a[c],duration:1200},360).add(Vt.smallDialSegment,{fill:f[l],duration:900},520).add(Vt.smallDialMaskPath,{rotate:$t.smallDial,duration:900},520).add(Vt.smallDialReveal,{fill:d[l],duration:900},520)}function B0(n){if(rl=n,window.clearTimeout(Fo),!n){F0(),ku(1e3);return}Pr==null||Pr.pause(),Hs.forEach(e=>e.pause()),er==null||er.pause(),tr==null||tr.reset(),Hs.clear()}async function z0(){const[n,e]=await Promise.all([Fc(".base","/assets/illus-b.svg","illustration-base"),Fc(".top","/assets/illus-t.svg","illustration-top")]);Vt=I0(n,e),tr=L0(Vt.fractal),Hu.classList.add("illustration--interactive"),vu(B0)}z0().catch(n=>console.error(n));const In=document.querySelector(".zigzag path"),V0=document.querySelectorAll(".links a"),Mi=In.getTotalLength(),Ps={mail:"#B9FEDA",twitter:"#DBDDF0",linkedin:"#FCE5CF"},Oc={easing:"easeInOutQuad",duration:300},G0=800/Mi;class H0{constructor(){mr(this,"animatePath",e=>{var i;const t=this.currentPath?parseFloat(In.style.strokeDashoffset):-Mi;(i=this.currentPath)==null||i.pause(),this.currentPath=Gs(In,{strokeDashoffset:[t,e],...Oc,duration:Math.abs(e-t)*G0})});mr(this,"animateColor",e=>{var t;(t=this.currentColor)==null||t.pause(),this.lastColor=e,this.currentColor=Gs(In,{stroke:e,...Oc})});mr(this,"setPathImmediately",e=>{var t;(t=this.currentPath)==null||t.pause(),In.style.strokeDashoffset=e});mr(this,"setColorImmediately",e=>{var t;(t=this.currentColor)==null||t.pause(),this.lastColor=e,In.style.stroke=e});this.currentPath=null,this.currentColor=null,this.lastColor=Ps.mail,In.style.strokeDasharray=Mi,In.style.strokeDashoffset=-Mi}}const qi=new H0;V0.forEach(n=>{const e=t=>{if(Ts.matches){t&&qi.setColorImmediately(Ps[n.id]),qi.setPathImmediately(t?0:-Mi);return}const r=parseFloat(In.style.strokeDashoffset)<=-Mi;t?(r?qi.setColorImmediately(Ps[n.id]):qi.animateColor(Ps[n.id]),qi.animatePath(0)):qi.animatePath(-Mi)};n.addEventListener("mouseenter",()=>e(!0)),n.addEventListener("mouseleave",()=>e(!1))});
