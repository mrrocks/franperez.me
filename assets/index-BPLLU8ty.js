...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function k_(n,e,t){const i=new Float32Array(Si),r=new H(0,1,0);return new Pn({name:"SphericalGaussianBlur",defines:{n:Si,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:pa(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function Dc(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:pa(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function Lc(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pa(),fragmentShader:`
	...
	`}class sf extends wn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new qu(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new ns(5,5,5),s=new Pn({name:"CubemapFromEquirect",uniforms:hr(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Zt,blending:Gn});s.uniforms.tEquirect.value=t;const a=new _n(r,s),o=t.minFilter;return t.minFilter===Ti&&(t.minFilter=kt),new $d(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,r);e.setRenderTarget(s)}}function W_(n){let e=new WeakMap,t=new WeakMap,i=null;function r(u,d=!1){return u==null?null:d?a(u):s(u)}function s(u){if(u&&u.isTexture){const d=u.mapping;if(d===Sa||d===Ea)if(e.has(u)){const _=e.get(u).texture;return o(_,u.mapping)}else{const _=u.image;if(_&&_.height>0){const S=new sf(_.height);return S.fromEquirectangularTexture(n,u),e.set(u,S),u.addEventListener("dispose",c),o(S.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const d=u.mapping,_=d===Sa||d===Ea,S=d===Ri||d===cr;if(_||S){let m=t.get(u);const p=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==p)return i===null&&(i=new Cc(n)),m=_?i.fromEquirectangular(u,m):i.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),m.texture;if(m!==void 0)return m.texture;{const M=u.image;return _&&M&&M.height>0||S&&M&&l(M)?(i===null&&(i=new Cc(n)),m=_?i.fromEquirectangular(u):i.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),u.addEventListener("dispose",f),m.texture):null}}}return u}function o(u,d){return d===Sa?u.mapping=Ri:d===Ea&&(u.mapping=cr),u}function l(u){let d=0;const _=6;for(let S=0;S<_;S++)u[S]!==void 0&&d++;return d===_}function c(u){const d=u.target;d.removeEventListener("dispose",c);const _=e.get(d);_!==void 0&&(e.delete(d),_.dispose())}function f(u){const d=u.target;d.removeEventListener("dispose",f);const _=t.get(d);_!==void 0&&(t.delete(d),_.dispose())}function h(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function X_(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Ko("WebGLRenderer: "+i+" extension not supported."),r}}}function Y_(n,e,t,i){const r={},s=new WeakMap;function a(h){const u=h.target;u.index!==null&&e.remove(u.index);for(const _ in u.attributes)e.remove(u.attributes[_]);u.removeEventListener("dispose",a),delete r[u.id];const d=s.get(u);d&&(e.remove(d),s.delete(u)),i.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(h,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function l(h){const u=h.attributes;for(const d in u)e.update(u[d],n.ARRAY_BUFFER)}function c(h){const u=[],d=h.index,_=h.attributes.position;let S=0;if(_===void 0)return;if(d!==null){const M=d.array;S=d.version;for(let y=0,T=M.length;y<T;y+=3){const D=M[y+0],b=M[y+1],w=M[y+2];u.push(D,b,b,w,w,D)}}else{const M=_.array;S=_.version;for(let y=0,T=M.length/3-1;y<T;y+=3){const D=y+0,b=y+1,w=y+2;u.push(D,b,b,w,w,D)}}const m=new(_.count>=65535?Yu:Xu)(u,1);m.version=S;const p=s.get(h);p&&e.remove(p),s.set(h,m)}function f(h){const u=s.get(h);if(u){const d=h.index;d!==null&&u.version<d.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:f}}function q_(n,e,t){let i;function r(h){i=h}let s,a;function o(h){s=h.type,a=h.bytesPerElement}function l(h,u){n.drawElements(i,u,s,h*a),t.update(u,i,1)}function c(h,u,d){d!==0&&(n.drawElementsInstanced(i,u,s,h*a,d),t.update(u,i,d))}function f(h,u,d){if(d===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,u,0,s,h,0,d);let S=0;for(let m=0;m<d;m++)S+=u[m];t.update(S,i,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=f}function Z_(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:rt("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function $_(n,e,t){const i=new WeakMap,r=new yt;function s(a,o,l){const c=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=f!==void 0?f.length:0;let u=i.get(o);if(u===void 0||u.count!==h){let I=function(){x.dispose(),i.delete(o),o.removeEventListener("dispose",I)};var d=I;u!==void 0&&u.texture.dispose();const _=o.morphAttributes.position!==void 0,S=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],M=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let T=0;_===!0&&(T=1),S===!0&&(T=2),m===!0&&(T=3);let D=o.attributes.position.count*T,b=1;D>e.maxTextureSize&&(b=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const w=new Float32Array(D*b*4*h),x=new Gu(w,D,b,h);x.type=bn,x.needsUpdate=!0;const R=T*4;for(let A=0;A<h;A++){const N=p[A],W=M[A],Y=y[A],C=D*b*4*A;for(let B=0;B<N.count;B++){const O=B*R;_===!0&&(r.fromBufferAttribute(N,B),w[C+O+0]=r.x,w[C+O+1]=r.y,w[C+O+2]=r.z,w[C+O+3]=0),S===!0&&(r.fromBufferAttribute(W,B),w[C+O+4]=r.x,w[C+O+5]=r.y,w[C+O+6]=r.z,w[C+O+7]=0),m===!0&&(r.fromBufferAttribute(Y,B),w[C+O+8]=r.x,w[C+O+9]=r.y,w[C+O+10]=r.z,w[C+O+11]=Y.itemSize===4?r.w:1)}}u={count:h,texture:x,size:new ot(D,b)},i.set(o,u),o.addEventListener("dispose",I)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const S=o.morphTargetsRelative?1:1-_;l.getUniforms().setValue(n,"morphTargetBaseInfluence",S),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",u.size)}return{update:s}}function K_(n,e,t,i,r){let s=new WeakMap;function a(c){const f=r.render.frame,h=c.geometry,u=e.get(c,h);if(s.get(u)!==f&&(e.update(u),s.set(u,f)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==f&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,f))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==f&&(d.update(),s.set(d,f))}return u}function o(){s=new WeakMap}function l(c){const f=c.target;f.removeEventListener("dispose",l),i.releaseStatesOfObject(f),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:a,dispose:o}}const j_={[bu]:"LINEAR_TONE_MAPPING",[Au]:"REINHARD_TONE_MAPPING",[Ru]:"CINEON_TONE_MAPPING",[wu]:"ACES_FILMIC_TONE_MAPPING",[Pu]:"AGX_TONE_MAPPING",[Du]:"NEUTRAL_TONE_MAPPING",[Cu]:"CUSTOM_TONE_MAPPING"};function J_(n,e,t,i,r){const s=new wn(e,t,{type:n,depthBuffer:i,stencilBuffer:r,depthTexture:i?new ur(e,t):void 0}),a=new wn(e,t,{type:Yn,depthBuffer:!1,stencilBuffer:!1}),o=new gn;o.setAttribute("position",new kn([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new kn([0,2,0,0,2,0],2));const l=new Gd({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new _n(o,l),f=new is(-1,1,1,-1,0,1);let h=null,u=null,d=!1,_,S=null,m=[],p=!1;this.setSize=function(M,y){s.setSize(M,y),a.setSize(M,y);for(let T=0;T<m.length;T++){const D=m[T];D.setSize&&D.setSize(M,y)}},this.setEffects=function(M){m=M,p=m.length>0&&m[0].isRenderPass===!0;const y=s.width,T=s.height;for(let D=0;D<m.length;D++){const b=m[D];b.setSize&&b.setSize(y,T)}},this.begin=function(M,y){if(d||M.toneMapping===Rn&&m.length===0)return!1;if(S=y,y!==null){const T=y.width,D=y.height;(s.width!==T||s.height!==D)&&this.setSize(T,D)}return p===!1&&M.setRenderTarget(s),_=M.toneMapping,M.toneMapping=Rn,!0},this.hasRenderPass=function(){return p},this.end=function(M,y){M.toneMapping=_,d=!0;let T=s,D=a;for(let b=0;b<m.length;b++){const w=m[b];if(w.enabled!==!1&&(w.render(M,D,T,y),w.needsSwap!==!1)){const x=T;T=D,D=x}}if(h!==M.outputColorSpace||u!==M.toneMapping){h=M.outputColorSpace,u=M.toneMapping,l.defines={},$e.getTransfer(h)===ct&&(l.defines.SRGB_TRANSFER="");const b=j_[u];b&&(l.defines[b]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=T.texture,M.setRenderTarget(S),M.render(c,f),S=null,d=!1},this.isCompositing=function(){return d},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),a.dispose(),o.dispose(),l.dispose()}}const af=new qt,Qo=new ur(1,1),of=new Gu,lf=new ed,cf=new qu,Ic=[],Uc=[],Nc=new Float32Array(16),Fc=new Float32Array(9),Oc=new Float32Array(4);function Tr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=Ic[r];if(s===void 0&&(s=new Float32Array(r),Ic[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function Lt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function It(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function ma(n,e){let t=Uc[e];t===void 0&&(t=new Int32Array(e),Uc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Q_(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function eg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2fv(this.addr,e),It(t,e)}}function tg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Lt(t,e))return;n.uniform3fv(this.addr,e),It(t,e)}}function ng(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4fv(this.addr,e),It(t,e)}}function ig(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),It(t,e)}else{if(Lt(t,i))return;Oc.set(i),n.uniformMatrix2fv(this.addr,!1,Oc),It(t,i)}}function rg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),It(t,e)}else{if(Lt(t,i))return;Fc.set(i),n.uniformMatrix3fv(this.addr,!1,Fc),It(t,i)}}function sg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),It(t,e)}else{if(Lt(t,i))return;Nc.set(i),n.uniformMatrix4fv(this.addr,!1,Nc),It(t,i)}}function ag(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function og(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2iv(this.addr,e),It(t,e)}}function lg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3iv(this.addr,e),It(t,e)}}function cg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4iv(this.addr,e),It(t,e)}}function ug(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function fg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2uiv(this.addr,e),It(t,e)}}function hg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3uiv(this.addr,e),It(t,e)}}function dg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4uiv(this.addr,e),It(t,e)}}function pg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Qo.compareFunction=t.isReversedDepthBuffer()?vl:xl,s=Qo):s=af,t.setTexture2D(e||s,r)}function mg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||lf,r)}function _g(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||cf,r)}function gg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||of,r)}function xg(n){switch(n){case 5126:return Q_;case 35664:return eg;case 35665:return tg;case 35666:return ng;case 35674:return ig;case 35675:return rg;case 35676:return sg;case 5124:case 35670:return ag;case 35667:case 35671:return og;case 35668:case 35672:return lg;case 35669:case 35673:return cg;case 5125:return ug;case 36294:return fg;case 36295:return hg;case 36296:return dg;case 35678:case 36198:case 36298:case 36306:case 35682:return pg;case 35679:case 36299:case 36307:return mg;case 35680:case 36300:case 36308:case 36293:return _g;case 36289:case 36303:case 36311:case 36292:return gg}}function vg(n,e){n.uniform1fv(this.addr,e)}function Mg(n,e){const t=Tr(e,this.size,2);n.uniform2fv(this.addr,t)}function Sg(n,e){const t=Tr(e,this.size,3);n.uniform3fv(this.addr,t)}function Eg(n,e){const t=Tr(e,this.size,4);n.uniform4fv(this.addr,t)}function Tg(n,e){const t=Tr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function yg(n,e){const t=Tr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function bg(n,e){const t=Tr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Ag(n,e){n.uniform1iv(this.addr,e)}function Rg(n,e){n.uniform2iv(this.addr,e)}function wg(n,e){n.uniform3iv(this.addr,e)}function Cg(n,e){n.uniform4iv(this.addr,e)}function Pg(n,e){n.uniform1uiv(this.addr,e)}function Dg(n,e){n.uniform2uiv(this.addr,e)}function Lg(n,e){n.uniform3uiv(this.addr,e)}function Ig(n,e){n.uniform4uiv(this.addr,e)}function Ug(n,e,t){const i=this.cache,r=e.length,s=ma(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),It(i,s));let a;this.type===n.SAMPLER_2D_SHADOW?a=Qo:a=af;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function Ng(n,e,t){const i=this.cache,r=e.length,s=ma(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),It(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||lf,s[a])}function Fg(n,e,t){const i=this.cache,r=e.length,s=ma(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),It(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||cf,s[a])}function Og(n,e,t){const i=this.cache,r=e.length,s=ma(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),It(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||of,s[a])}function Bg(n){switch(n){case 5126:return vg;case 35664:return Mg;case 35665:return Sg;case 35666:return Eg;case 35674:return Tg;case 35675:return yg;case 35676:return bg;case 5124:case 35670:return Ag;case 35667:case 35671:return Rg;case 35668:case 35672:return wg;case 35669:case 35673:return Cg;case 5125:return Pg;case 36294:return Dg;case 36295:return Lg;case 36296:return Ig;case 35678:case 36198:case 36298:case 36306:case 35682:return Ug;case 35679:case 36299:case 36307:return Ng;case 35680:case 36300:case 36308:case 36293:return Fg;case 36289:case 36303:case 36311:case 36292:return Og}}class zg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=xg(t.type)}}class Vg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Bg(t.type)}}class Gg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const ja=/(\w+)(\])?(\[|\.)?/g;function Bc(n,e){n.seq.push(e),n.map[e.id]=e}function Hg(n,e,t){const i=n.name,r=i.length;for(ja.lastIndex=0;;){const s=ja.exec(i),a=ja.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Bc(t,c===void 0?new zg(o,n,e):new Vg(o,n,e));break}else{let h=t.map[o];h===void 0&&(h=new Gg(o),Bc(t,h)),t=h}}}class Ys{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);Hg(o,l,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function zc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const kg=37297;let Wg=0;function Xg(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const Vc=new Be;function Yg(n){$e._getMatrix(Vc,$e.workingColorSpace,n);const e=`mat3( ${Vc.elements.map(t=>t.toFixed(4))} )`;switch($e.getTransfer(n)){case na:return[e,"LinearTransferOETF"];case ct:return[e,"sRGBTransferOETF"];default:return De("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Gc(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),s=(n.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+s+`

`+Xg(n.getShaderSource(e),o)}else return s}function qg(n,e){const t=Yg(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Zg={[bu]:"Linear",[Au]:"Reinhard",[Ru]:"Cineon",[wu]:"ACESFilmic",[Pu]:"AgX",[Du]:"Neutral",[Cu]:"Custom"};function $g(n,e){const t=Zg[e];return t===void 0?(De("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ps=new H;function Kg(){$e.getLuminanceCoefficients(Ps);const n=Ps.x.toFixed(4),e=Ps.y.toFixed(4),t=Ps.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const s0={[Gs]:"SHADOWMAP_TYPE_PCF",[Nr]:"SHADOWMAP_TYPE_VSM"};function a0(n){return s0[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const o0={[Ri]:"ENVMAP_TYPE_CUBE",[cr]:"ENVMAP_TYPE_CUBE",[ha]:"ENVMAP_TYPE_CUBE_UV"};function l0(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":o0[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const c0={[cr]:"ENVMAP_MODE_REFRACTION"};function u0(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":c0[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const f0={[yu]:"ENVMAP_BLENDING_MULTIPLY",[_h]:"ENVMAP_BLENDING_MIX",[gh]:"ENVMAP_BLENDING_ADD"};function h0(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":f0[n.combine]||"ENVMAP_BLENDING_NONE"}function d0(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function p0(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=a0(t),c=l0(t),f=u0(t),h=h0(t),u=d0(t),d=jg(t),_=Jg(s),S=r.createProgram();let m,p,M=t.glslVersion?"#version "+t.glslVersion+`
 ...
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Lr=(n=1.68)=>e=>Ji(e,+n),sl={in:n=>e=>n(e),out:n=>e=>1-n(1-e),inOut:n=>e=>e<.5?n(e*2)/2:1-n(e*-2+2)/2,outIn:n=>e=>e<.5?(1-n(1-e*2))/2:(n(e*2-1)+1)/2},Rx=Rl/2,cu=Rl*2,uu={[mr]:Lr,Quad:Lr(2),Cubic:Lr(3),Quart:Lr(4),Quint:Lr(5),Sine:n=>1-hx(n*Rx),Circ:n=>1-ux(1-n*n),Expo:n=>n?Ji(2,10*n-10):0,Bounce:n=>{let e,t=4;for(;n<((e=Ji(2,--t))-1)/11;);return 1/Ji(4,3-t)-7.5625*Ji((e*3-2)/22-n,2)},Back:(n=1.7)=>e=>(+n+1)*e*e*e-+n*e*e,Elastic:(n=1,e=.3)=>{const t=pn(+n,1,10),i=pn(+e,at,2),r=i/cu*px(1/t),s=cu/i;return a=>a===0||a===1?a:-t*Ji(2,-10*(1-a))*fx((1-a-r)*s)}},io=(()=>{const n={linear:hi,none:hi};for(let e in sl)for(let t in uu){const i=uu[t],r=sl[e];n[e+t]=t===mr||t==="Back"||t==="Elastic"?(s,a)=>r(i(s,a)):r(i)}return n})(),Ls={linear:hi,none:hi},wx=n=>{if(Ls[n])return Ls[n];if(n.indexOf("(")<=-1){const t=sl[n]||n.includes("Back")||n.includes("Elastic")?io[n]():io[n];return t?Ls[n]=t:hi}else{const e=n.slice(0,-1).split("("),t=io[e[0]];return t?Ls[n]=t(...e[1].split(",")):hi}},fu=["steps(","irregular(","linear(","cubicBezier("],al=n=>{if(xr(n)){for(let t=0,i=fu.length;t<i;t++)if(Wn(n,fu[t]))return console.warn(`String syntax for \`ease: "${n}"\` has been removed from the core and replaced by importing and passing the easing function directly: \`ease: ${n}\``),hi}return Pi(n)?n:xr(n)?wx(n):hi};/**
 * Anime.js - animation - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Ie=wl(),ke=wl(),Zi={},Is={func:null},Us={func:null},Ns=[null],$i=[null,null],Fs={to:null};let Cx=0,hu=0,ii,En;const Px=(n,e)=>{const t={};if(gr(n)){const i=[].concat(...n.map(r=>Object.keys(r))).filter(qs);for(let r=0,s=i.length;r<s;r++){const a=i[r],o=n.map(l=>{const c={};for(let f in l){const h=l[f];qs(f)?f===a&&(c.to=h):c[f]=h}return c});t[a]=o}}else{const i=Dt(e.duration,Pt.defaults.duration);Object.keys(n).map(s=>({o:parseFloat(s)/100,p:n[s]})).sort((s,a)=>s.o-a.o).forEach(s=>{const a=s.o,o=s.p;for(let l in o)if(qs(l)){let c=t[l];c||(c=t[l]=[]);const f=a*i;let h=c.length,u=c[h-1];const d={to:o[l]};let _=0;for(let S=0;S<h;S++)_+=c[S].duration;h===1&&(d.from=u.to),o.ease&&(d.ease=o.ease),d.duration=f-(h?_:0),c.push(d)}return s});for(let s in t){const a=t[s];let o;for(let l=0,c=a.length;l<c;l++){const f=a[l],h=f.ease;f.ease=o||void 0,o=h}a[0].duration||a.shift()}}return t};class Ll extends Dl{constructor(e,t,i,r,s=!1,a=0,o){super(t,i,r),this._head,this._tail,++hu;const l=Ax(e),c=l.length,f=t.keyframes,h=f?Mf(Px(f,t),t):t,{id:u,delay:d,duration:_,ease:S,playbackEase:m,modifier:p,composition:M,onRender:y}=h,T=i?i.defaults:Pt.defaults,D=Dt(S,T.ease),b=Dt(m,T.playbackEase),w=b?al(b):null,x=!Je(D.ease),R=x?D.ease:Dt(S,w?"linear":T.ease),I=x?D.settlingDuration:Dt(_,T.duration),A=Dt(d,T.delay),N=p||T.modifier,W=Je(M)&&c>=pr?Ot.none:Je(M)?T.composition:M,Y=this._offset+(i?i._offset:0);x&&(D.parent=this);let C=NaN,B=NaN,O=0,j=0;for(let z=0;z<c;z++){const J=l[z],ue=a||z,xe=o||l;let He=NaN,et=NaN;for(let Ce in h)if(qs(Ce)){const q=Tf(J,Ce),ce=Ef(J,Ce),te=bf(Ce,J,q);let fe=h[Ce];const Te=gr(fe);if(s&&!Te&&($i[0]=fe,$i[1]=fe,fe=$i),Te){const Re=fe.length,nt=!Hr(fe[0]);Re===2&&nt?(Fs.to=fe,Ns[0]=Fs,ii=Ns):Re>2&&nt?(ii=[],fe.forEach((Ke,ht)=>{ht?ht===1?($i[1]=Ke,ii.push($i)):ii.push(Ke):$i[0]=Ke})):ii=fe}else Ns[0]=fe,ii=Ns;let ye=null,Ze=null,Le=NaN,qe=0,tt=0;for(let Re=ii.length;tt<Re;tt++){const nt=ii[tt];Hr(nt)?En=nt:(Fs.to=nt,En=Fs),Is.func=null,Us.func=null;const Ke=Fn(Dt(En.composition,W),J,ue,xe,null,null),ht=Al(Ke)?Ke:Ot[Ke];!ye&&ht!==Ot.none&&(ye=Pl(J,te));const L=ye?ye._tail:null,lt=i&&L&&L.parent.parent===i?L:Ze,Ue=Fn(En.to,J,ue,xe,Is,lt);let Ne;Hr(Ue)&&!Je(Ue.to)?(En=Ue,Ne=Ue.to):Ne=Ue;const ae=Fn(En.from,J,ue,xe,Us,lt),We=En.ease||R,E=Fn(We,J,ue,xe,null,lt),g=Pi(E)||xr(E)?E:We,F=!Je(g)&&!Je(g.ease),$=F?g.ease:g,Q=F?g.settlingDuration:Fn(Dt(En.duration,Re>1?Fn(I,J,ue,xe,null,lt)/Re:I),J,ue,xe,null,lt),ne=Fn(Dt(En.delay,tt?0:A),J,ue,xe,null,lt),re=En.modifier||N,X=!Je(ae),K=!Je(Ne),he=gr(Ne),ve=he||X&&K,le=Ze?qe:0,ie=Ze?qe+ne:ne,Pe=gt(Y+ie,12),Ve=gt(Y+le,12);!j&&(X||he)&&(j=1);let Oe=Ze;if(ht!==Ot.none){let we=ye._head;for(;we&&we._absoluteStartTime<=Pe;)if(we._isOverridden||(Oe=we),we=we._nextRep,we&&we._absoluteStartTime>=Pe)for(;we;)js(we),we=we._nextRep}if(ve){an(he?Fn(Ne[0],J,ue,xe,Us,lt):ae,Ie),an(he?Fn(Ne[1],J,ue,xe,Is,lt):Ne,ke);const we=Dr(J,te,q,Zi);Ie.t===je.NUMBER&&(Oe?Oe._valueType===je.UNIT&&(Ie.t=je.UNIT,Ie.u=Oe._unit):(an(we,fn),fn.t===je.UNIT&&(Ie.t=je.UNIT,Ie.u=fn.u)))}else K?an(Ne,ke):Ze?tu(Ze,ke):an(i&&Oe&&Oe.parent.parent===i?Oe._value:Dr(J,te,q,Zi),ke),X?an(ae,Ie):Ze?tu(Ze,Ie):an(i&&Oe&&Oe.parent.parent===i?Oe._value:Dr(J,te,q,Zi),Ie);if(Ie.o&&(Ie.n=$s(Oe?Oe._toNumber:an(Dr(J,te,q,Zi),fn).n,Ie.n,Ie.o)),ke.o&&(ke.n=$s(Ie.n,ke.n,ke.o)),Ie.t!==ke.t){if(Ie.t===je.COMPLEX||ke.t===je.COMPLEX){const we=Ie.t===je.COMPLEX?Ie:ke,ze=Ie.t===je.COMPLEX?ke:Ie;ze.t=je.COMPLEX,ze.s=Ht(we.s),ze.d=we.d.map(()=>ze.n)}else if(Ie.t===je.UNIT||ke.t===je.UNIT){const we=Ie.t===je.UNIT?Ie:ke,ze=Ie.t===je.UNIT?ke:Ie;ze.t=je.UNIT,ze.u=we.u}else if(Ie.t===je.COLOR||ke.t===je.COLOR){const we=Ie.t===je.COLOR?Ie:ke,ze=Ie.t===je.COLOR?ke:Ie;ze.t=je.COLOR,ze.d=we.d.map(()=>0)}}if(Ie.u!==ke.u){let we=ke.u?Ie:ke;we=lu(J,we,ke.u?ke.u:Ie.u,!1)}if(ke.d&&Ie.d&&ke.d.length!==Ie.d.length){const we=Ie.d.length>ke.d.length?Ie:ke,ze=we===Ie?ke:Ie;ze.d=we.d.map((xn,Kt)=>Je(ze.d[Kt])?0:ze.d[Kt]),ze.s=Ht(we.s)}const P=gt(+Q||at,12);let se=Zi[te];nr(se)||(Zi[te]=null);const Z=ce?ce.set:null;qe=gt(ie+P,12);const pe=Ie.d,oe=ke.d,ee=ke.s,ge={parent:this,id:Cx++,property:te,target:J,_value:null,_toFunc:Is.func,_fromFunc:Us.func,_ease:al($),_fromNumbers:pe?Ht(pe):Ds,_toNumbers:oe?Ht(oe):Ds,_strings:ee?Ht(ee):Ds,_fromNumber:Ie.n,_toNumber:ke.n,_numbers:pe?Ht(pe):Ds,_number:Ie.n,_unit:ke.u,_modifier:re,_currentTime:0,_startTime:ie,_delay:+ne,_updateDuration:P,_changeDuration:P,_absoluteStartTime:Pe,_absoluteUpdateStartTime:Ve,_absoluteEndTime:gt(Y+qe,12),_hasFromValue:X||he?1:0,_tweenType:q,_setter:Z,_valueType:ke.t,_composition:ht,_isOverlapped:0,_isOverridden:0,_renderTransforms:0,_inlineValue:se,_prevRep:null,_nextRep:null,_prevAdd:null,_nextAdd:null,_prev:null,_next:null};ht!==Ot.none&&Cf(ge,ye);const Fe=ge._valueType;if(Fe===je.COMPLEX)ge._value=yf(ge,1,-1);else if(Fe===je.UNIT)ge._value=`${re(ge._toNumber)}${ge._unit}`;else if(Fe===je.COLOR){const we=ke.d;ge._value=`rgba(${gt(we[0],0)},${gt(we[1],0)},${gt(we[2],0)},${we[3]})`}else ge._value=re(ge._toNumber);isNaN(Le)&&(Le=ge._startTime),Ze=ge,O++,Ai(this,ge)}(isNaN(B)||Le<B)&&(B=Le),(isNaN(C)||qe>C)&&(C=qe),q===xt.TRANSFORM&&(He=O-tt,et=O)}if(!isNaN(He)){let Ce=0;vt(this,q=>{Ce>=He&&Ce<et&&(q._renderTransforms=1,q._composition===Ot.blend&&vt(rr.animation,ce=>{ce.id===q.id&&(ce._renderTransforms=1)})),Ce++})}}c||console.warn("No target found. Make sure the element you're trying to animate is accessible before creating your animation."),B?(vt(this,z=>{z._startTime-z._delay||(z._delay-=B),z._startTime-=B}),C-=B):B=0,C||(C=at,this.iterationCount=0),this.targets=l,this.id=Je(u)?hu:u,this.duration=C===at?at:ga((C+this._loopDelay)*this.iterationCount-this._loopDelay)||at,this.onRender=y||T.onRender,this._ease=w,this._delay=B,this.iterationDuration=C,!this._autoplay&&j&&this.onRender(this)}stretch(e){const t=this.duration;if(t===ir(e))return this;const i=e/t;return vt(this,r=>{r._updateDuration=ir(r._updateDuration*i),r._changeDuration=ir(r._changeDuration*i),r._currentTime*=i,r._delay*=i,r._startTime*=i,r._absoluteStartTime*=i,r._absoluteUpdateStartTime*=i,r._absoluteEndTime*=i}),super.stretch(e)}refresh(){return vt(this,e=>{const t=e._toFunc,i=e._fromFunc;(t||i)&&(i?(an(i(),Ie),Ie.u!==e._unit&&e.target[dr]&&lu(e.target,Ie,e._unit,!0),e._fromNumbers=Ht(Ie.d),e._fromNumber=Ie.n):t&&(an(Dr(e.target,e.property,e._tweenType),fn),e._fromNumbers=Ht(fn.d),e._fromNumber=fn.n),t&&(an(t(),ke),e._toNumbers=Ht(ke.d),e._strings=Ht(ke.s),e._toNumber=ke.o?$s(e._fromNumber,ke.n,ke.o):ke.n))}),this.duration===at&&this.restart(),this}revert(){return super.revert(),Cl(this)}then(e){return super.then(e)}}const Jr=(n,e)=>new Ll(n,e,null,0,!1).init();/**
 * Anime.js - timeline - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Dx=(n,e)=>{if(Wn(e,"<")){const t=e[1]==="<",i=n._tail,r=i?i._offset+i._delay:0;return t?r:r+i.duration}},Os=(n,e)=>{let t=n.iterationDuration;if(t===at&&(t=0),Je(e))return t;if(Al(+e))return+e;const i=e,r=n?n.labels:null,s=!nr(r),a=Dx(n,i),o=!Je(a),l=rx.exec(i);if(l){const c=l[0],f=i.split(c),h=s&&f[0]?r[f[0]]:t,u=o?a:s?h:t,d=+f[1];return $s(u,d,c[0])}else return o?a:s?Je(r[i])?t:r[i]:t};/**
 * Anime.js - timeline - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */function Lx(n){return ga((n.iterationDuration+n._loopDelay)*n.iterationCount-n._loopDelay)||at}function ro(n,e,t,i,r,s){const o=Al(n.duration)&&n.duration<=at?t-at:t;e.composition&&Ei(e,o,1,1,nn.AUTO);const l=i?new Ll(i,n,e,o,!1,r,s):new Dl(n,e,o);return e.composition&&l.init(!0),Ai(e,l),vt(e,c=>{const h=c._offset+c._delay+c.duration;h>e.iterationDuration&&(e.iterationDuration=h)}),e.duration=Lx(e),e}let du=0;class Ix extends Dl{constructor(e={}){super(e,null,0),++du,this.id=Je(e.id)?du:e.id,this.duration=0,this.labels={};const t=e.defaults,i=Pt.defaults;this.defaults=t?Mf(t,i):i,this.composition=Dt(e.composition,!0),this.onRender=e.onRender||i.onRender;const r=Dt(e.playbackEase,i.playbackEase);this._ease=r?al(r):null,this.iterationDuration=0}add(e,t,i){const r=Hr(t),s=Hr(e);if(r||s){if(this._hasChildren=!0,r){const a=t,o=i&&i.type==="Stagger"&&Pt.editor,l=Pi(i)?i:null;if(l||o){const c=rl(e),f=this.duration,h=this.iterationDuration,u=a.id;let d=0;c.length;const _=l||Pt.editor.resolveStagger(i.defaultValue);c.forEach(S=>{const m={...a};this.duration=f,this.iterationDuration=h,Je(u)||(m.id=u+"-"+d);const p=Os(this,_(S,d,c,null,this));ro(m,this,p,S,d,c),d++})}else{const c=a,f=i&&i.type?i.defaultValue:i;ro(c,this,Os(this,f),e)}}else ro(e,this,Os(this,t));return this.composition&&this.init(!0),this}}sync(e,t){if(Je(e)||e&&Je(e.pause))return this;e.pause();const i=+(e.effect?e.effect.getTiming().duration:e.duration);return!Je(e)&&!Je(e.persist)&&(e.persist=!0),this.add(e,{currentTime:[0,i],duration:i,delay:0,ease:"linear",playbackEase:"linear"},t)}set(e,t,i){return Je(t)?this:(t.duration=at,t.composition=Ot.replace,this.add(e,t,i))}call(e,t){return Je(e)||e&&!Pi(e)?this:this.add({duration:0,delay:0,onComplete:()=>e(this)},t)}label(e,t){return Je(e)||e&&!xr(e)?this:(this.labels[e]=Os(this,t),this)}remove(e,t){return Df(rl(e),this,t),this}stretch(e){const t=this.duration;if(t===ir(e))return this;const i=e/t,r=this.labels;vt(this,s=>s.stretch(s.duration*i));for(let s in r)r[s]*=i;return super.stretch(e)}refresh(){return vt(this,e=>{e.refresh&&e.refresh()}),this}revert(){return super.revert(),vt(this,e=>e.revert,!0),Cl(this)}then(e){return super.then(e)}}const Ux=n=>new Ix(n).init();/**
 * Anime.js - utils - ESM
 * @version v4.5.0
 * @license MIT
 * @copyright 2026 - Julian Garnier
 */const Ir=(n,e)=>{if(!Je(e))return e.duration=at,e.composition=Dt(e.composition,Ot.none),new Ll(n,e,null,0,!0).resume()};Nt.pauseOnDocumentHidden=!0;function Lf(n){const e=()=>n(document.visibilityState==="visible");return e(),document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)}const ri=Math.PI*2,vr=16,so=1e3/60,oa=1024,Nx=1.5,mt={speed:1.08,pointCount:14,scale:1,padding:60,breathingRange:.03,centerPull:.4,smoothing:.05,maxDistance:.7,morphIntensity:.02,morphRandomness:.02,rippleAmplitude:.7,smoothness:.2,timeStep:.006,colorStep:.001},If=[{x:0,y:0,size:1.1},{x:1,y:0,size:.9},{x:0,y:1,size:.9},{x:1,y:1,size:1.1}];function ao(n,e){return n+Math.random()*(e-n)}function Fx(){const n=Math.random()*360;return[0,74,166,282].map(t=>({l:ao(.974,.986),c:ao(.032,.046),h:(n+t+ao(-9,9)+360)%360}))}function sr(n,e,t){return n+(e-n)*t}function Ox(n,e,t){const i=e-n,r=Math.abs(i)>180?n+(i>0?360:-360):n;return(sr(r,e,t)%360+360)%360}function Bx({l:n,c:e,h:t}){const i=t*Math.PI/180,r=e*Math.cos(i),s=e*Math.sin(i),a=(n+.3963377774*r+.2158037573*s)**3,o=(n-.1055613458*r-.0638541728*s)**3,l=(n-.0894841775*r-1.291485548*s)**3,c=4.0767416621*a-3.3077115913*o+.2309699292*l,f=-1.2684380046*a+2.6097574011*o-.3413193965*l,h=-.0041960863*a-.7034186147*o+1.707614701*l,u=d=>{const _=Zh.clamp(d,0,1);return _<=.0031308?12.92*_:1.055*_**(1/2.4)-.055};return[u(c),u(f),u(h)]}const ci=new Float32Array(vr*4);for(let n=0;n<vr;n++){const e=n/vr,t=1-e,i=n*4;ci[i]=t**3,ci[i+1]=3*t**2*e,ci[i+2]=3*t*e**2,ci[i+3]=e**3}function pu(n,e,t,i,r){const s=r*4;return ci[s]*n+ci[s+1]*e+ci[s+2]*t+ci[s+3]*i}const si=Fx(),mu=Array.from({length:oa},(n,e)=>{const t=e/oa*si.length,i=Math.floor(t),r=(i+1)%si.length,s=t%1;return Bx({l:sr(si[i].l,si[r].l,s),c:sr(si[i].c,si[r].c,s),h:Ox(si[i].h,si[r].h,s)})}),Bs=mt.pointCount*vr;class zx{constructor(e,t,i){this.index=e,this.definition=If[e],this.points=new Float32Array(mt.pointCount*2),this.rotation=Math.random()*ri,this.rotationSpeed=.002*(Math.random()-.5)*mt.speed,this.time=Math.random()*ri,this.phase=Math.random()*ri,this.frequency=.5+Math.random(),this.sizePhase=Math.random()*ri,this.breathingAmount=Math.random()*mt.breathingRange,this.pointOffsets=Array.from({length:mt.pointCount},()=>Math.random()*ri),this.distortion=mt.morphIntensity+Math.random()*mt.morphRandomness,this.colorTime=e*(Math.PI/2),this.geometry=this.createGeometry(),this.material=new Tl({depthTest:!1,depthWrite:!1,toneMapped:!1}),this.mesh=new _n(this.geometry,this.material),this.mesh.frustumCulled=!1,this.mesh.renderOrder=e,this.resize(t,i),this.updateColor(!1)}createGeometry(){const e=new Float32Array((Bs+1)*3),t=new Uint16Array(Bs*3);for(let r=0;r<Bs;r++){const s=r*3;t[s]=0,t[s+1]=(r+1)%Bs+1,t[s+2]=r+1}const i=new gn;return i.setAttribute("position",new $t(e,3)),i.setIndex(new $t(t,1)),i}resize(e,t){const i=e*this.definition.size,r=this.definition.x*t.width,s=this.definition.y*t.height;if(this.baseRadius){const a=i/this.baseRadius;this.x=r+(this.x-this.anchorX)*a,this.y=s+(this.y-this.anchorY)*a,this.radius*=a}else this.x=r,this.y=s,this.radius=i;this.baseRadius=i,this.anchorX=r,this.anchorY=s,this.updateShape(),this.updateGeometry()}update(e,t,i){this.updateMovement(t,i),this.resolveCollisions(e),this.updateShape(),this.updateGeometry(),this.updateColor(!0,i)}updateMovement(e,t){const i=this.definition.x*e.width,r=this.definition.y*e.height,s=Math.hypot(i-this.x,r-this.y),a=this.baseRadius*mt.maxDistance,o=this.baseRadius*8e-4,l=1-(1-mt.smoothing)**t;this.time+=mt.timeStep*mt.speed*t,this.rotation+=this.rotationSpeed*t,this.radius=this.baseRadius*(1+Math.sin(this.time*.4+this.sizePhase)*this.breathingAmount);const c=this.x+Math.sin(this.time*.2*this.frequency+this.phase)*o,f=this.y+Math.cos(this.time*.3*this.frequency+this.phase)*o,h=s>a*.5?Math.min(1,(s-a*.5)/a)*mt.centerPull*s:0,u=h?(i-this.x)/s*h:0,d=h?(r-this.y)/s*h:0;this.x+=(c-this.x+u)*l,this.y+=(f-this.y+d)*l}resolveCollisions(e){e.forEach(t=>{if(t===this)return;const i=this.x-t.x,r=this.y-t.y,s=Math.hypot(i,r),a=this.radius+t.radius+mt.padding;if(s>=a)return;const o=Math.atan2(r,i),l=(a-s)/2,c=Math.cos(o)*l,f=Math.sin(o)*l;this.x+=c,this.y+=f,t.x-=c,t.y-=f})}updateShape(){const e=ri/mt.pointCount,t=this.time*.9;for(let i=0;i<mt.pointCount;i++){const r=i*e+this.rotation,s=Math.sin(t+this.pointOffsets[i])*this.distortion+Math.sin(t*1.5+this.pointOffsets[(i+3)%mt.pointCount])*this.distortion*mt.rippleAmplitude,a=this.radius*(1+s),o=i*2;this.points[o]=this.x+Math.cos(r)*a,this.points[o+1]=this.y+Math.sin(r)*a}}updateGeometry(){const e=this.geometry.attributes.position.array,t=mt.smoothness*(this.radius/this.baseRadius);e[0]=this.x,e[1]=this.y;for(let i=0;i<mt.pointCount;i++){const r=i*2,s=(i+1)%mt.pointCount*2,a=(i+2)%mt.pointCount*2,o=(i-1+mt.pointCount)%mt.pointCount*2,l=this.points[r],c=this.points[r+1],f=this.points[s],h=this.points[s+1],u=l+(f-this.points[o])*t,d=c+(h-this.points[o+1])*t,_=f-(this.points[a]-l)*t,S=h-(this.points[a+1]-c)*t;for(let m=0;m<vr;m++){const M=(1+i*vr+m)*3;e[M]=pu(l,u,_,f,m),e[M+1]=pu(c,d,S,h,m)}}this.geometry.attributes.position.needsUpdate=!0}updateColor(e=!0,t=1){e&&(this.colorTime+=mt.colorStep*mt.speed*t);const i=this.colorTime%ri/ri*oa,r=Math.floor(i),s=(r+1)%oa,a=i%1,o=mu[r],l=mu[s];this.material.color.setRGB(sr(o[0],l[0],a),sr(o[1],l[1],a),sr(o[2],l[2],a),Ft)}}const Vx=document.querySelector("canvas"),Xn=new ff({canvas:Vx,alpha:!1,antialias:!0}),xa=new Wu,Bn=new is(0,1,0,1,0,2),en={width:window.innerWidth,height:window.innerHeight};let ol=Math.max(en.width/2,en.height/2)*mt.scale,Js=0,_u;Xn.outputColorSpace=Ft;Xn.setClearColor(16777215,1);Bn.position.z=1;const la=If.map((n,e)=>new zx(e,ol,en));la.forEach(({mesh:n})=>xa.add(n));function Gx(n){la.forEach(e=>e.update(la,en,n)),Xn.render(xa,Bn)}function Hx(n){const e=Js?Math.min(n-Js,so*3):so;Js=n,Gx(e/so)}function Uf(){en.width=window.innerWidth,en.height=window.innerHeight,ol=Math.max(en.width/2,en.height/2)*mt.scale,Xn.setPixelRatio(Math.min(window.devicePixelRatio||1,Nx)),Xn.setSize(en.width,en.height,!1),Bn.left=0,Bn.right=en.width,Bn.top=0,Bn.bottom=en.height,Bn.updateProjectionMatrix(),la.forEach(n=>n.resize(ol,en)),Xn.render(xa,Bn)}function kx(){window.cancelAnimationFrame(_u),_u=window.requestAnimationFrame(Uf)}function Wx(n){if(Xn.setAnimationLoop(null),!n){Xn.render(xa,Bn);return}Js=0,Xn.setAnimationLoop(Hx)}window.addEventListener("resize",kx);Uf();Lf(Wx);const Xx=[.68,.32,.265,.69,.15,.06],Yx=[.2289,.6917,.0793],qx=[.3127,.329],Zx=new Be().set(.4865709,.2656677,.1982173,.2289746,.6917385,.0792869,0,.0451134,1.0439444),$x=new Be().set(2.4934969,-.9313836,-.4027108,-.829489,1.7626641,.0236247,.0358458,-.0761724,.9568845),Il="display-p3",Kx={primaries:Xx,whitePoint:qx,transfer:ct,toXYZ:Zx,fromXYZ:$x,luminanceCoefficients:Yx,outputColorSpaceConfig:{drawingBufferColorSpace:Il}};({...$e.spaces[Ft]});const Nf=document.querySelector(".illustration"),jx=new DOMParser,St={x:0,y:320,width:240,height:120},Jx=2,Mt={depth:18,duration:8e3,roughness:.86,saturation:1.22,ambientIntensity:2.85,lightIntensity:1.15,interactionRadius:155,interactionStrength:1.75,interactionLift:1.15,interactionFollow:.26,interactionRelease:.055,interactionTargetDecay:.86,lightSmoothing:.18,lightDecay:.82,maximumInteractionSpeed:14},Qx=["#94f4c3","#a2f8cc","#acfed4","#b0fbd5","#b9feda","#c2fee0","#c5fee1","#d4fee9"],ev=new Set(Qx);$e.spaces[Il]=Kx;const ll=window.matchMedia("(color-gamut: p3)").matches?Il:Ft,ft={dial:0,disc:0,gear:0,smallDial:0,splitDisc:0},Qr=new Set;let Rt,ar,ca,cl,zn,kr=!1,Ff,ua=!1;function tv(n,e){const t=new Map;n.querySelectorAll("[id]").forEach(i=>{const r=i.id,s=`${e}-${r}`;t.set(r,s),i.id=s}),n.querySelectorAll("*").forEach(i=>{for(const r of i.attributes){let s=r.value;t.forEach((a,o)=>{s=s.replaceAll(`url(#${o})`,`url(#${a})`),s===`#${o}`&&(s=`#${a}`)}),r.value=s}})}async function gu(n,e,t){const i=await fetch(e);if(!i.ok)throw new Error(`Unable to load ${e}`);const s=jx.parseFromString(await i.text(),"image/svg+xml").documentElement;return tv(s,t),s.classList.add("illustration__svg"),Nf.querySelector(n).replaceChildren(s),s}function zs(n,{x:e,y:t,width:i,height:r}){const s=n.getBBox(),a=s.x+s.width/2,o=s.y+s.height/2;return a>=e&&a<=e+i&&o>=t&&o<=t+r}function Ki(n,e){return n.forEach(t=>t.classList.add("illustration__part",`illustration__part--${e}`)),n}function nv(n){const e=n.match(/[a-zA-Z]|[-+]?(?:\d*\.)?\d+(?:e[-+]?\d+)?/g)??[],t=[];let i,r,s=0,a=0,o=0,l=0,c=0;const f=_=>/^[a-zA-Z]$/.test(_),h=()=>c<e.length&&!f(e[c]),u=()=>Number(e[c++]),d=(_,S)=>{s=_,a=S,r.push({x:_,y:S})};for(;c<e.length;){if(f(e[c])&&(i=e[c++]),!i)throw new Error(`Invalid path data: ${n}`);const _=i===i.toLowerCase();switch(i.toUpperCase()){case"M":{let S=!0;for(;h();){const m=u()+(_?s:0),p=u()+(_?a:0);S&&(r=[],t.push(r),o=m,l=p,S=!1),d(m,p)}i=_?"l":"L";break}case"L":for(;h();){const S=u()+(_?s:0),m=u()+(_?a:0);d(S,m)}break;case"H":for(;h();){const S=u()+(_?s:0);d(S,a)}break;case"V":for(;h();){const S=u()+(_?a:0);d(s,S)}break;case"Z":s=o,a=l,i=void 0;break;default:throw new Error(`Unsupported path command: ${i}`)}}return t}function iv(n){const e=n[0],t=n.at(-1);return e.x===t.x&&e.y===t.y?n.slice(0,-1):n}function rv(n){const e=ll===Ft?new st(n):new st().setRGB(...[1,3,5].map(i=>Number.parseInt(n.slice(i,i+2),16)/255),ll),t=e.r*.2126+e.g*.7152+e.b*.0722;return e.r=t+(e.r-t)*Mt.saturation,e.g=t+(e.g-t)*Mt.saturation,e.b=t+(e.b-t)*Mt.saturation,e}function sv(n){const e=[],t=new Map,i=[],r=[],s=({x:a,y:o})=>{const l=`${a.toFixed(3)},${o.toFixed(3)}`;if(!t.has(l)){const c=a-St.x,f=o-St.y,h=Math.min(c,St.width-c,f,St.height-f),u=c/St.width,d=f/St.height;t.set(l,e.length),e.push({baseX:c,baseY:f,x:c,y:f,z:0,amplitudeX:h?Math.min(16,Math.max(6,h*.38)):0,amplitudeY:h?Math.min(12,Math.max(5,h*.3)):0,amplitudeZ:h?Math.min(Mt.depth,Math.max(6,h*.5)):0,interactionX:0,interactionY:0,interactionZ:0,interactionTargetX:0,interactionTargetY:0,interactionTargetZ:0,phase:(u*1.25+d*.75)*Math.PI})}return t.get(l)};return n.forEach(a=>{const o=rv(a.getAttribute("fill"));nv(a.getAttribute("d")).forEach(l=>{const c=iv(l),f=c.map(s),h=c.map(({x:u,y:d})=>new ot(u,d));bl.triangulateShape(h,[]).forEach(u=>{u.forEach(d=>{i.push(f[d]),r.push(o.r,o.g,o.b)})})})}),{colors:new Float32Array(r),triangleVertexIndices:new Uint16Array(i),vertices:e}}function av(n){const e=document.createElement("canvas"),t=n[0].ownerSVGElement,i=[...t.querySelectorAll(":scope > path[fill]")].find(R=>{const I=R.getBBox();return I.x===St.x&&I.y===St.y&&I.width===St.width&&I.height===St.height}),{colors:r,triangleVertexIndices:s,vertices:a}=sv(n),o=new Float32Array(s.length*3),l=new $t(o,3),c=new gn,f=new Hd({metalness:0,roughness:Mt.roughness,side:yn,vertexColors:!0}),h=new _n(c,f),u=new ff({alpha:!0,antialias:!0,canvas:e,powerPreference:"high-performance"}),d=new Wu,_=new is(0,St.width,0,St.height,.1,500),S=new Zd(16777215,Mt.ambientIntensity),m=new qd(16777215,Mt.lightIntensity),p={progress:0},M={active:!1,x:0,y:0,lastX:0,lastY:0,lastTime:0,targetVelocityX:0,targetVelocityY:0,velocityX:0,velocityY:0};let y=0,T=performance.now();e.className="illustration__fractal",e.setAttribute("aria-hidden","true"),t.parentElement.prepend(e),i.style.visibility="hidden",n.forEach(R=>{R.style.visibility="hidden"}),l.setUsage(Rh),c.setAttribute("position",l),c.setAttribute("color",new $t(r,3)),h.frustumCulled=!1,_.position.z=200,m.target.position.set(St.width/2,St.height/2,0),d.add(h,S,m,m.target),u.outputColorSpace=ll,u.setClearColor(0,0);const D=()=>{M.active=!1,M.lastTime=0,M.targetVelocityX=0,M.targetVelocityY=0,a.forEach(R=>{R.interactionTargetX=0,R.interactionTargetY=0,R.interactionTargetZ=0})},b=R=>{const I=e.getBoundingClientRect(),A=(R.clientX-I.left)/I.width*St.width,N=(R.clientY-I.top)/I.height*St.height;if(!(A>=0&&A<=St.width&&N>=0&&N<=St.height)){D();return}if(!M.active)M.active=!0,M.lastX=A,M.lastY=N,M.lastTime=R.timeStamp;else{const Y=Math.min(50,Math.max(8,R.timeStamp-M.lastTime)),C=1e3/60/Y;let B=(A-M.lastX)*C,O=(N-M.lastY)*C,j=Math.hypot(B,O);if(j>Mt.maximumInteractionSpeed){const z=Mt.maximumInteractionSpeed/j;B*=z,O*=z,j=Mt.maximumInteractionSpeed}M.targetVelocityX=B,M.targetVelocityY=O,a.forEach(z=>{if(!z.amplitudeX)return;const J=Math.hypot(z.x-A,z.y-N),ue=Math.max(0,1-J/Mt.interactionRadius)**2;z.interactionTargetX=B*Mt.interactionStrength*ue,z.interactionTargetY=O*Mt.interactionStrength*ue,z.interactionTargetZ=j*Mt.interactionLift*ue}),M.lastX=A,M.lastY=N,M.lastTime=R.timeStamp}M.x=A,M.y=N};t.parentElement.addEventListener("pointermove",b,{passive:!0}),t.parentElement.addEventListener("pointerleave",D);const w=()=>{const R=Math.min(window.devicePixelRatio||1,Jx);y!==R&&(y=R,u.setPixelRatio(y),u.setSize(St.width,St.height,!1))};return{render:()=>{w();const R=performance.now(),I=Math.min(2,(R-T)/(1e3/60));T=R,M.velocityX+=(M.targetVelocityX-M.velocityX)*Mt.lightSmoothing*I,M.velocityY+=(M.targetVelocityY-M.velocityY)*Mt.lightSmoothing*I,M.targetVelocityX*=Mt.lightDecay**I,M.targetVelocityY*=Mt.lightDecay**I,a.forEach(A=>{const N=Math.sin(p.progress+A.phase),W=Math.sin(p.progress*2-A.phase*.5),B=1-(1-(Math.abs(A.interactionTargetX)+Math.abs(A.interactionTargetY)+Math.abs(A.interactionTargetZ)>.05?Mt.interactionFollow:Mt.interactionRelease))**I;A.interactionX+=(A.interactionTargetX-A.interactionX)*B,A.interactionY+=(A.interactionTargetY-A.interactionY)*B,A.interactionZ+=(A.interactionTargetZ-A.interactionZ)*B,A.interactionTargetX*=Mt.interactionTargetDecay**I,A.interactionTargetY*=Mt.interactionTargetDecay**I,A.interactionTargetZ*=Mt.interactionTargetDecay**I,A.x=A.baseX+A.amplitudeX*(N*.72+W*.28)+A.interactionX,A.y=A.baseY+A.amplitudeY*(Math.cos(p.progress+A.phase*.8)*.72+Math.sin(p.progress*2+A.phase)*.28)+A.interactionY,A.z=A.amplitudeZ*(Math.sin(p.progress-A.phase)*.72+Math.sin(p.progress*2+A.phase*.5)*.28)+A.interactionZ}),s.forEach((A,N)=>{const W=a[A],Y=N*3;o[Y]=W.x,o[Y+1]=W.y,o[Y+2]=W.z}),l.needsUpdate=!0,c.computeVertexNormals(),m.position.set(St.width/2+Math.cos(p.progress)*St.width+M.velocityX*3,St.height/2+Math.sin(p.progress)*St.height+M.velocityY*3,140),u.render(d,_)},state:p}}function ov(n,e){const t=[...n.querySelectorAll(":scope > path")],i=Ki(t.filter(p=>zs(p,{x:404,y:64,width:60,height:60})),"disc"),r=Ki(t.filter(p=>zs(p,{x:144,y:224,width:20,height:20})),"split-disc"),s=Ki([[...n.querySelectorAll(":scope > g[mask]")][1]],"gear")[0],a=[...e.querySelectorAll(":scope > g[mask]")][0],o=[...a.querySelectorAll(":scope > path")][0],l=e.querySelector(":scope > mask"),c=Ki([l.querySelector(":scope > path")],"dial-mask")[0],f=Ki([e.querySelector(':scope > path[fill="#6439ED"]:last-of-type')],"dial-cap")[0],h=e.querySelector(':scope > rect[x="44"]'),u=h.cloneNode(),d=[...e.querySelectorAll(':scope > path[fill="#F7C595"]')].find(p=>zs(p,{x:44,y:414,width:52,height:26})),_=document.createElementNS("http://www.w3.org/2000/svg","mask"),S=document.createElementNS("http://www.w3.org/2000/svg","path");_.id="illustration-small-dial-mask",_.setAttribute("maskUnits","userSpaceOnUse"),_.setAttribute("x","44"),_.setAttribute("y","426"),_.setAttribute("width","28"),_.setAttribute("height","28"),S.setAttribute("d","M44 440h28v14H44z"),S.setAttribute("fill","#fff"),_.append(S),e.prepend(_),h.after(u),u.setAttribute("mask",`url(#${_.id})`),Ki([S],"small-dial-mask"),a.before(o),l.setAttribute("x","234"),l.setAttribute("y","434"),l.setAttribute("width","252"),l.setAttribute("height","252");const m=[...e.querySelectorAll(":scope > path[fill]")].filter(p=>{const M=p.getBBox();return ev.has(p.getAttribute("fill").toLowerCase())&&zs(p,{x:0,y:320,width:240,height:120})&&M.width*M.height<2e4});return{dialCap:f,dialCircle:a.querySelector(":scope > circle"),dialEllipse:a.querySelector(":scope > ellipse"),dialMaskPath:c,disc:i,fractal:m,gear:s,knob:n.querySelector(':scope > rect[x="345"]'),smallDialMaskPath:S,smallDialReveal:u,smallDialSegment:d,splitDisc:r}}function Br(n){return getComputedStyle(document.documentElement).getPropertyValue(n).trim()}function Mr(n,e){return n+Math.random()*(e-n)}function Qi(n){return n[Math.floor(Math.random()*n.length)]}function xu(n){return(Math.round(n/90)%4+4)%4}function Ur(n,e){return(Math.round(n/e)*e%360+360)%360}function zr(n){if(n==="gear"){ft.gear=Ur(ft.gear,90),Ir(Rt.gear,{rotate:ft.gear});return}if(n==="disc"){ft.disc=Ur(ft.disc,90),ft.splitDisc=Ur(ft.splitDisc,90),Ir(Rt.disc,{rotate:ft.disc}),Ir(Rt.splitDisc,{rotate:ft.splitDisc});return}if(n==="dial"){ft.dial=Ur(ft.dial,90),Ir([Rt.dialMaskPath,Rt.dialCap],{rotate:ft.dial});return}ft.smallDial=Ur(ft.smallDial,90),Ir(Rt.smallDialMaskPath,{rotate:ft.smallDial})}function lv(){["gear","disc","dial","smallDial"].forEach(zr)}function cv(n,e,t,i=0){const r=n.getAttribute(e),s=Jr(n,{[e]:[r,t,r],opacity:[1,.82,1],delay:i,duration:Mr(1200,1700),ease:"inOut(3)",onComplete:()=>Qr.delete(s)});Qr.add(s)}function uv(){cv(Rt.knob,"fill",Br("--color-secondary"),180)}function fv(){if(ar){ar.play();return}ar=Jr(ca.state,{progress:Math.PI*2,duration:Mt.duration,ease:"linear",loop:!0,onUpdate:()=>ca.render()})}function vu(n=[]){const e=["gear","disc","dial","smallDial"],t=e.filter(i=>i!==Ff&&!n.includes(i));return Qi(t.length?t:e)}function Mu(n,e,t){const i=Mr(680,1080);if(e==="gear"){ft.gear-=Qi([90,180]),n.add(Rt.gear,{rotate:ft.gear,duration:i,onComplete:()=>zr(e)},t);return}if(e==="disc"){ft.disc+=Qi([90,180]),n.add(Rt.disc,{rotate:ft.disc,duration:i,onComplete:()=>zr(e)},t),Math.random()<.7&&(ft.splitDisc-=Qi([90,180]),n.add(Rt.splitDisc,{rotate:ft.splitDisc,duration:i*.8},t+Mr(i*.08,i*.15)));return}const r=Br("--color-accent"),s=Br("--color-highlight"),a=Br("--color-primary"),o=Br("--color-secondary"),l="#f7c595";if(e==="dial"){ft.dial+=Qi([90,90,180]);const u=xu(ft.dial),d=[s,a,o,l],_=[r,o,l,a],S=[a,l,s,o];n.add(Rt.dialMaskPath,{rotate:ft.dial,duration:i,onComplete:()=>zr(e)},t).add(Rt.dialCap,{fill:S[u],rotate:ft.dial,duration:i},t).add(Rt.dialEllipse,{fill:d[u],duration:i},t).add(Rt.dialCircle,{fill:_[u],duration:i},t);return}ft.smallDial-=Qi([90,90,180]);const c=xu(Math.abs(ft.smallDial)),f=[l,o,r,l],h=[r,l,s,o];n.add(Rt.smallDialSegment,{fill:f[c],duration:i},t).add(Rt.smallDialMaskPath,{rotate:ft.smallDial,duration:i,onComplete:()=>zr(e)},t).add(Rt.smallDialReveal,{fill:h[c],duration:i},t)}function Of(n=Mr(350,950)){window.clearTimeout(cl),!(!ua||!Rt)&&(cl=window.setTimeout(hv,n))}function hv(){if(!ua||!Rt||kr)return;const n=vu(),e=Math.random()<.45?vu([n]):void 0;Ff=n,!Qr.size&&Math.random()<.35&&uv(),kr=!0,zn=Ux({defaults:{ease:"inOut(3)"},onComplete:()=>{lv(),kr=!1,Of(Mr(350,950))}}),Mu(zn,n,0),e&&Mu(zn,e,Mr(180,360))}function dv(n){if(ua=n,window.clearTimeout(cl),ua){fv(),kr?(zn==null||zn.play(),Qr.forEach(e=>e.play())):Of(500);return}kr&&(zn==null||zn.complete()),Qr.forEach(e=>e.complete()),ar==null||ar.pause()}async function pv(){const[n,e]=await Promise.all([gu(".base","/assets/illus-b.svg","illustration-base"),gu(".top","/assets/illus-t.svg","illustration-top")]);Rt=ov(n,e),ca=av(Rt.fractal),ca.render(),Nf.classList.add("illustration--interactive"),Lf(dv)}pv().catch(n=>console.error(n));const On=document.querySelector(".zigzag path"),mv=document.querySelectorAll(".links a"),or=On.getTotalLength(),ul={mail:"#B9FEDA",twitter:"#DBDDF0",linkedin:"#FCE5CF"},Su={easing:"easeInOutQuad",duration:300},_v=800/or;class gv{constructor(){yr(this,"animatePath",e=>{var i;const t=this.currentPath?parseFloat(On.style.strokeDashoffset):-or;(i=this.currentPath)==null||i.pause(),this.currentPath=Jr(On,{strokeDashoffset:[t,e],...Su,duration:Math.abs(e-t)*_v})});yr(this,"animateColor",e=>{var t;(t=this.currentColor)==null||t.pause(),this.lastColor=e,this.currentColor=Jr(On,{stroke:e,...Su})});yr(this,"setPathImmediately",e=>{var t;(t=this.currentPath)==null||t.pause(),On.style.strokeDashoffset=e});yr(this,"setColorImmediately",e=>{var t;(t=this.currentColor)==null||t.pause(),this.lastColor=e,On.style.stroke=e});this.currentPath=null,this.currentColor=null,this.lastColor=ul.mail,On.style.strokeDasharray=or,On.style.strokeDashoffset=-or}}const Vs=new gv;mv.forEach(n=>{const e=t=>{const r=parseFloat(On.style.strokeDashoffset)<=-or;t?(r?Vs.setColorImmediately(ul[n.id]):Vs.animateColor(ul[n.id]),Vs.animatePath(0)):Vs.animatePath(-or)};n.addEventListener("mouseenter",()=>e(!0)),n.addEventListener("mouseleave",()=>e(!1))});const xv="http://www.w3.org/2000/svg",vv=[...document.querySelectorAll(".project-link, .links a")];let Eu=[],Tu;function ai(n,e={}){const t=document.createElementNS(xv,n);return Object.entries(e).forEach(([i,r])=>t.setAttribute(i,r)),t}function Mv(n,e){const t=n.textContent,i=[...n.childNodes].find(({nodeType:A})=>A===Node.TEXT_NODE),r=n.getBoundingClientRect(),s=getComputedStyle(n),a=document.createElement("canvas").getContext("2d");a.font=s.font;const o=a.measureText(t),c=(r.height-o.actualBoundingBoxAscent-o.actualBoundingBoxDescent)/2+o.actualBoundingBoxAscent+3.5,f=`project-link-pattern-${e}`,h=`project-link-mask-${e}`,u=ai("svg",{class:"project-link__underline",viewBox:`0 0 ${r.width} ${r.height}`,"aria-hidden":"true",focusable:"false"}),d=ai("defs");let _="M-12 2";for(let A=-12;A<24;A+=6)_+=`C${A+1} 0 ${A+2} 0 ${A+3} 2S${A+5} 4 ${A+6} 2`;const S=ai("pattern",{id:f,x:"0",y:String(c),width:"12",height:"4",patternUnits:"userSpaceOnUse"}),m=ai("path",{d:_,fill:"none","shape-rendering":"geometricPrecision",stroke:"#6439ed","stroke-linecap":"round","stroke-linejoin":"round","stroke-opacity":".55","stroke-width":"1.2"}),p=ai("mask",{id:h,x:"-4",y:"0",width:String(r.width+8),height:String(r.height),maskUnits:"userSpaceOnUse"}),M=ai("rect",{x:"-4",y:"0",width:String(r.width+8),height:String(r.height),fill:"#fff"}),y=[...t].flatMap((A,N)=>{if(!/[gjpqy]/i.test(A))return[];const W=document.createRange();W.setStart(i,N),W.setEnd(i,N+1);const Y=W.getBoundingClientRect(),C=Y.width+.75;return[ai("rect",{x:String(Y.left-r.left+(Y.width-C)/2),y:String(c-2),width:String(C),height:"8",rx:"0.5",fill:"#000"})]}),T=ai("rect",{x:"0",y:String(c),width:String(r.width),height:"4",fill:`url(#${f})`,mask:`url(#${h})`}),D={offset:0};let b;S.append(m),p.append(M,...y),d.append(S,p),u.append(d,T),n.append(u);const w=()=>{if(!b){b=Jr(D,{offset:12,duration:800,ease:"linear",loop:!0,onUpdate:()=>S.setAttribute("x",String(D.offset))});return}b.play()},x=()=>{b==null||b.pause()},R=()=>{n.matches(":focus-visible")||x()},I=()=>{n.matches(":hover")||x()};return n.addEventListener("mouseenter",w),n.addEventListener("mouseleave",R),n.addEventListener("focus",w),n.addEventListener("blur",I),n.matches(":hover, :focus-visible")&&w(),{destroy(){b==null||b.pause(),n.removeEventListener("mouseenter",w),n.removeEventListener("mouseleave",R),n.removeEventListener("focus",w),n.removeEventListener("blur",I),u.remove()}}}function Bf(){Eu.forEach(({destroy:n})=>n()),Eu=vv.map(Mv)}document.fonts.ready.then(Bf);window.addEventListener("resize",()=>{window.cancelAnimationFrame(Tu),Tu=window.requestAnimationFrame(Bf)});
